...
(function() {
    ...
    Music.prototype = {
        total: 70,
        pageSize: 10,
        dataUrl: "https://tingapi.ting.baidu.com/v1/restserver/ting?method=baidu.ting.search.common",
        playerUrl: "https://box.baidu.com/widget/flash/bdspacesong.swf",
        ...
        _buildMusicHtml: function(playerUrl) {
            var html = '<embed class="BDE_try_Music" allowfullscreen="false" pluginspage="https://www.macromedia.com/go/getflashplayer"';
            html += ' src="' + playerUrl + '"';
