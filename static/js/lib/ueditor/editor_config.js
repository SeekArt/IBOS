...
(function () {
     ...
     */
    var URL;
    window.UEDITOR_HOME_URL = G.STATIC_URL + "/js/lib/ueditor/"
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
		,imageUrl: Ibos.app.url("main/editor/imageUp")       //图片上传提交地址
        ,imagePath:''                       //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        //,compressSide:0                            //等比压缩的基准，确定maxImageSideLength参数的参照对象。0为按照最长边，1为按照宽度，2为按照高度
        ,maxImageSideLength:20000                    //上传图片最大允许的边长，超过会自动等比缩放,不缩放就设置一个比较大的值，更多设置在image.html中
        ...
        //附件上传配置区
        ,fileUrl:Ibos.app.url("main/editor/fileUp")        //附件上传提交地址
        ...
        //图片在线管理配置区
        ,imageManagerUrl:Ibos.app.url("main/editor/imageManager")       //图片在线管理的处理地址
        ,imageManagerPath:''                                    //图片修正地址，同imagePath

        //屏幕截图配置区
        ,snapscreenHost: '127.0.0.1'                                  //屏幕截图的server端文件所在的网站地址或者ip，请不要加http://
        ,snapscreenServerUrl: Ibos.app.url("main/editor/imageUp") //屏幕截图的server端保存程序，UEditor的范例代码为“URL +"server/upload/php/snapImgUp.php"”
        ,snapscreenPath: ''
        //,snapscreenServerPort: 80                                    //屏幕截图的server端端口
        //,snapscreenImgAlign: ''                                //截图的图片默认的排版方式

        //word转存配置区
        ,wordImageUrl:Ibos.app.url("main/editor/imageUp")             //word转存提交地址
        ,wordImagePath:''                       //
        ...
        ,initialStyle:'body{font-size:14px; font-family: "Microsoft Yahei"}'   //编辑器内部样式,可以用来改变字体等
...
UEDITOR_CONFIG.mode = {
    ...
    simple: [
        ['paragraph', 'fontfamily', 'fontsize', 'bold', 'italic',
                'underline', 'strikethrough', 'forecolor', 'backcolor', '|', 'inserttable', '|',
                'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify',
                'insertorderedlist', 'insertunorderedlist', 'indent', '|', 'link', 'unlink', 'insertimage', 'emotion'
        ]
    ],
    full: [
        [ 'source', '|', 'undo', 'redo', '|',
                ...
                'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', '|', 
                'link', 'unlink', 'anchor', '|', 'imagenone', 'imageleft', 'imageright', 'imagecenter', '|',
                'insertimage', 'emotion', 'scrawl', 'insertvideo', 'music', 'attachment', 'map', 'gmap', 'insertframe', 'highlightcode', 'pagebreak', 'template', 'background', '|',
                'horizontal', 'date', 'time', 'spechars', 'snapscreen', 'wordimage', '|',
                'inserttable', 'deletetable', 'insertparagraphbeforetable', 'insertrow', 'deleterow', 'insertcol', 'deletecol', 'mergecells', 'splittocells', '|',
                'print', 'searchreplace'
        ]
    ]
};
