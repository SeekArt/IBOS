					...
					<% if ( !filesorkCheck.filesorkCheckRes ){ %>
						<% for( var item in filesorkCheck.filesockItems){ %>
							<tr>
    							<td><%= item %></td>
								<td>
                                    <% if ( filesorkCheck.filesorkCheckRes[item].status ) { %>
    									支持
    								<% }else{ %>
    									支持
    								<% } %>
								</td>
    							<td><%= filesorkCheck.filesorkCheckRes[item].advice %></td>
    							<td><i class="<% if( filesorkCheck.filesorkCheckRes[item].status ){ %>o-normal-pass<% }else{ %>o-not-pass<% } %>"></i></td>
							</tr>
    					<% } %>
					<% } %>
