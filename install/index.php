...
<html lang="en">
	...
	<body>
							...
							<form action="javascript:;" class="form-horizontal form-narrow" id="user_form">
								<table class="table table-info" id="table_info">
									<tbody>
											...
											<td>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<span id="administrator_password_tip" class="ml nomatch-tip">请填写5到32位数字或者字母！</span>
													</div>
												</div>
												<div class="control-group">
										...
										<tr>
											...
											<td>
												...
												<div class="control-group">
													...
													<div class="controls">
														<input type="text" name="shortname" class="span6" id="short_name" data-type="shortname" placeholder="企业名称缩写，通常2-10个中文缩写" />
										...
										<tr>
											...
											<td>
												<div class="control-group">
													<label class="control-label">数据库用户名<span class="necessary-write">*</span></label>
													<div class="controls">
														<input type="text" class="span6" data-type="username" id="database_name" name="dbAccount" value="">
												...
												<div class="control-group">
													...
													<div class="controls">
														<input type="text" class="span6" data-type="DBpassword" id="database_password" name="dbPassword" value=''>
												...
												<div class="hidden-info">
													<div class="control-group">
														...
														<div class="controls">
															<input type="text" class="span6" id="database_server" name="dbHost" value="">
												...
												<div class="control-group install-choose" id="tablepre_exist_tip">
													<label class="control-label"><span class="constraint-install">强制安装</span></label>
													<div class="controls">
								...
								<div class="content-foot nbt clearfix">
									...
									<div class="pull-right">
										...
										<button type="button" class="btn btn-large btn-primary btn-install" id="btn_install">立即安装</button>
									</div>
								</div>
							</form>
						</div>
						...
						<form action="javascript:;" method="post" id="custom_form" class="form-horizontal form-narrow">
							<div class="specific-content">
								...
								<div class="content-foot clearfix nbt">
									...
									<div class="pull-right">
										<input type="submit" name="submitInstallModule" class="btn btn-large btn-primary" value="立即安装" />
									</div>
								</div>
						</form>
					</section>
		...
		<script type="text/template" id="env_check_tpl">
			...
			<td><i class="<% if( funcCheck.funcItems[item].status ){ %>o-normal-pass<% }else{ %>o-not-pass<% } %>"></i></td>
			</tr>
			<% } %>
			...
			<td><i class="<% if( filesorkCheck.filesockItems[item].status ){ %>o-normal-pass<% }else{ %>o-not-pass<% } %>"></i></td>
			</tr>
			<% } %>
			<% } %>
			...
			<td><i class="<% if( extLoadedCheck.extLoadedItems[item].status ){ %>o-normal-pass<% }else{ %>o-not-pass<% } %>"></i></td>
			</tr>
			<% } %>
			<% } %>
			</tbody>
		...
		<script type="text/template" id="module_tpl">
			...
			<input type="checkbox" name="<%= name %>[]" value="<%= attr %>" checked <% if(name == 'coreModules'){ %>disabled<% } %> />
