...
namespace application\extensions\ThinkImage;
...
class ThinkImage
{
    ...
    public function __construct($type = THINKIMAGE_GD, $imgname = null)
    {
        ...
        switch ($type) {
            case THINKIMAGE_GD:
                $class = 'application\extensions\ThinkImage\Driver\ImageGd';
                break;
            case THINKIMAGE_IMAGICK:
                $class = 'application\extensions\ThinkImage\Driver\ImageImagick';
                break;
            default:
