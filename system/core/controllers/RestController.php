...
/**
 * 继承到ICController的 IBOS controller文件.
 *
 ...
 * @version $Id: RestController.php 3420 2014-05-22 11:47:51Z Aeolus $
 * @author banyanCheung <banyan@ibos.com.cn>
 */
...
class RestController extends Controller
{
    ...
    public function run($actionID)
    {
        ...
        $method = 'action' . ucfirst($this->_method);
        if (!method_exists($this, $action) && method_exists($this, $method)) {
            $actionID = $this->_method;
        }
        parent::run($actionID);
    }
