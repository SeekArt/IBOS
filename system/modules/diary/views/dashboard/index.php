            ...
            <div class="ctb">
                ...
                <div class="ctbw">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="checkbox" name="reviewlock" value='1' id="" data-toggle="switch"
                                   class="visi-hidden" <?php if ($config['reviewlock']): ?>checked<?php endif; ?>>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label"><?php echo $lang['Sharing log server']; ?></label>
                        <div class="controls">
                            <input type="checkbox" name="sharepersonnel" value='1' id="" data-toggle="switch"
                                   class="visi-hidden" <?php if ($config['sharepersonnel']): ?>checked<?php endif; ?>>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label"><?php echo $lang['To share logs to give comments']; ?></label>
                        <div class="controls">
                            <input type="checkbox" name="sharecomment" value='1' id="" data-toggle="switch"
                                   class="visi-hidden" <?php if ($config['sharecomment']): ?>checked<?php endif; ?>>
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label"><?php echo $lang['Focus on logging']; ?></label>
                        <div class="controls">
                            <input type="checkbox" name="attention" value='1' id="" data-toggle="switch"
                                   class="visi-hidden" <?php if ($config['attention']): ?>checked<?php endif; ?>>
                        </div>
                    </div>
                    <div class="control-group">
                        <label for=""
                               class="control-label"><?php echo $lang['A key to remind the default content']; ?></label>
                        <div class="controls">
                            <input type="text" name="remindcontent" value="<?php echo $config['remindcontent']; ?>">
                            <div
                                class="help-inline"><?php echo $lang['The staff did not write the log that day will receive this message'] ?></div>
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="" class="control-label"><?php echo $lang['Stamp function']; ?></label>
                        <div class="controls">
                            <input type="checkbox" id="stamp_switch" name="stampenable" value='1' id=""
                                   data-toggle="switch" class="visi-hidden"
                                   <?php if ($config['stampenable']): ?>checked<?php endif; ?>>
                        </div>
                    </div>
                </div>
                ...
                <div id="stamp_setup_box">
                            ...
                            <div class="controls">
                                <select name="pointsystem" id="point_sys" class="span6">
                                    <option value="10"
                                            ...
                                            if ($config['pointsystem'] == 10):

                                            ?>selected<?php endif; ?>><?php echo $lang['Ten point scale']; ?></option>
                                    <option value="5"
                                            <?php

                                            if ($config['pointsystem'] == 5):

                                            ?>selected<?php endif; ?>><?php echo $lang['Five point scale']; ?></option>
                                    <option value="3"
                                            <?php

                                            if ($config['pointsystem'] == 3):

                                            ?>selected<?php endif; ?>><?php echo $lang['Three point scale']; ?></option>
                                </select>
                            </div>
                        </div>
                    </div>
                    <div>
                        <div class="control-group">
                            <div class="controls">
                                <table id="stamp_slot_table"
                                       class="table table-bordered table-striped ps-table pull-left"
                                       style="width: 300px;">
                                    <thead>
                                    <tr>
                                        ...
                                        <th>
                                            <label class="checkbox pull-right"
                                                   title="<?php echo $lang['Autoreview tip']; ?>"><input type="checkbox"
                                                                                                         name="autoreview"
                                                                                                         id="auto_apprise"
                                                                                                         value="1"><?php echo $lang['Auto comment']; ?>
                                            </label>
                                        </th>
                                    </tr>
                                    </thead>
                                    ...
                                    if (count($stamps) > 0):
                                        ...
                                        if ($score > $config['pointsystem']
                                            ...
                                            <tr <?php if ($score > $config['pointsystem']): ?>style="display: none;"<?php endif; ?>>
                                                ...
                                                <td>
                                                    <label class="radio pull-right" style="display: none;"><input
                                                            type="radio" name="apprise"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="stamp-slot" data-node-type="stampSlot">
                                                        <div class="stamp-item ui-draggable"
...
<script
    src="<?php echo util\Ibos::app()->assetManager->getAssetsUrl('diary'); ?>/js/diary_dashboard_index.js?<?php echo VERHASH; ?>"></script>
<script>
