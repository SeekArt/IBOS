			...
			<div class="page-list-header">
				...
				<div class="btn-group pull-left mls">
					<a href="<?php echo $this->createUrl( 'review/index', array( 'date' => 'yesterday' ) ) ?>" class="btn 
						<?php $curDate = Env::getRequest( 'date' ); if ( $curDate == 'yesterday' || !isset( $curDate ) ): ?>active<?php endif; ?>"><?php echo $lang['Yesterday']; ?></a>
				...
				<div class="btn-group pull-right">
					<a href="<?php echo $this->createUrl( 'review/index', array( 'date' => $prevAndNextDate['prev'], 'uid' => $subUids ) ); ?>" class="btn">
							...
							<li class="da-list-item">
								<div class="da-summary">
									<div class="avatar-box">
										<a href="<?php echo $this->createUrl( 'review/personal', array( 'uid' => $diary['uid'] ) ) ?>" class="avatar-circle">
										...
										<?php if ( $dashboardConfig['attention'] ): ?>
											<a href="javascript:;" data-action="toggleAsterisk" <?php if ( $diary['isattention'] ): ?>class="o-da-asterisk"<?php else: ?>class="o-da-unasterisk"<?php endif; ?> data-param='{"id": "<?php echo $diary['uid']; ?>"}'></a>
										<?php endif; ?>
									</div>
									<div class="das-content">
										<p class="xcm mb">
											<a href="javascript:;" data-action="showDiaryDetail" data-param='{"id": "<?php echo $diary['diaryid']; ?>", "fromController": "<?php echo $this->id; ?>"}'><?php echo $diary['content']; ?></a>
										</p>
										<div class="da-list-item-desc">
											<div class="pull-right">
												<a href="<?php echo $this->createUrl( 'review/show', array( 'diaryid' => $diary['diaryid'] ) ) ?>" target="_blank" class="o-more cbtn" title="<?php echo $lang['More']; ?>"></a>
											</div>
											<span class="fss"><?php echo $diary['addtime']; ?></span>
											<span class="fss ilsep">|</span>
											<a href="javascript:;" data-node-type="showComment" class="fss" data-id="<?php echo $diary['diaryid']; ?>"><?php echo $lang['Review']; ?> <em><?php echo $diary['commentcount']; ?></em></a>
											<span class="fss ilsep">|</span>
								...
								<div class="da-detail" style="display:none;" data-id="<?php echo $diary['diaryid']; ?>"></div>
								<div class="da-mark-down-wrap">
									<a href="javascript:;" class="da-mark-down" data-action="showDiaryDetail" data-param='{"id": "<?php echo $diary['diaryid']; ?>", "fromController": "<?php echo $this->id; ?>"}'></a>
								</div>
							</li>
						<?php endforeach; ?>
					<?php else: ?>
					...
					<div class="da-remind">
						...
						<ul class="da-remind-list">
							...
							<li data-uid="<?php echo $user['uid']; ?>">
								<a href="<?php echo $this->createUrl( 'review/personal', array( 'uid' => $user['uid'] ) ); ?>" target="_blank" class="avatar-box">
									<span class="avatar-circle">
										<img class="mbm" src="static.php?type=avatar&uid=<?php echo $user['uid']; ?>&size=middle&engine=<?php echo ENGINE; ?>" alt="">
									</span>
									<span class="avatar-desc"><strong><?php echo $user['realname']; ?></strong></span>
								</a>
							</li>
							<?php endforeach; ?>
							<li class="da-bell">
								<?php if(Main::getCookie('reminded_' . strtotime($date))): ?>
									<a href="javascript:" class="">
										...
										<span class="avatar-desc"><strong><?php echo $lang['Reminded']; ?></strong></span>
									</a>
								<?php else: ?>
									<a href="javascript:" class="avatar-box" data-action="remindUnderling">
										<i class="o-da-bell"></i>
										<span class="avatar-desc"><strong><?php echo $lang['Remind to write log']; ?></strong></span>
									</a>
								<?php endif; ?>
							</li>
						</ul>
