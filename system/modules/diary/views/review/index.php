								...
								<div class="da-summary">
									<div class="avatar-box">
										<a href="<?php echo $this->createUrl( 'review/personal', array( 'uid' => $diary['uid'] ) ) ?>" class="avatar-circle">
											<img class="mbm" src="<?php echo Org::getDataStatic( $diary['uid'], 'avatar', 'middle' ) ?>" alt="">
										</a>
									...
									<div class="das-content">
										...
										<div class="da-list-item-desc">
											...
											<?php if ( $diary['stamp'] > 0 ): ?>
												...
												&nbsp;&nbsp;<img width="60" height="24" id="diary_stamp_<?php echo $diary['diaryid']; ?>" src="<?php echo  $iconUrl; ?>"/>
											<?php endif; ?>
										</div>
									</div>
								</div>
