    ...
    <div class="mcr">
        ...
        <div class="page-list">
            <div class="page-list-header">
                <form
                    action="<?php echo $this->createUrl('review/personal', array('param' => 'search', 'uid' => $user['uid'])); ?>"
                    method="post">
