						...
						<?php foreach ( $data as $diary ) { ?>
							<li class="da-list-item">
								<div class="da-summary">
									<a href="<?php echo $this->createUrl( 'review/show', array( 'diaryid' => $diary['diaryid'] ) ); ?>" class="datebox">
									...
									<div class="das-content">
										...
										<div class="da-list-item-desc">
											<div class="pull-right">
												<a href="<?php echo $this->createUrl( 'review/show', array( 'diaryid' => $diary['diaryid'] ) ); ?>" class="o-more cbtn" title="<?php echo $lang['More']; ?>" target="_blank"></a>
											</div>
								...
								<div class="da-detail" data-id="<?php echo $diary['diaryid']; ?>" style="display:none;">
								</div>
...
<div id="mn_search_advance" style="width: 400px; display:none;">
    <form id="mn_search_advance_form" method="post" action="<?php echo $this->createUrl( 'review/personal', array( 'param' => 'search', 'uid' => $user['uid'] ) ); ?>" class="form-horizontal form-compact">
