	...
	<?php if ( !$loadmore ): ?>
		...
		<?php if(isset($allowComment) && $allowComment): ?>
			<div class="cmt-item" id="newCommentBox_<?php echo $rowid; ?>" data-node-type="commentBox">
				...
				<div class="cmt-body">
					<textarea rows="3" class="mbs comment-box" id="commentBox_<?php echo $rowid; ?>" placeholder="<?php echo $lang['Say something...']; ?>" data-node-type="commentText"></textarea>
					<div class="mbs fss clearfix">
						<a href="javascript:;" title="<?php echo $lang['Expression']; ?>" class="cbtn o-expression comment-btn" id="comment_emotion_<?php echo $rowid; ?>" data-node-type="commentEmotion" data-act="face"></a>
