				...
				<div class="ml mb">
					<ul class="list-inline log-info-list">
						<?php foreach ( $nums as $count ): ?>
							<li>
								<div class="clearfix">
									<a href="<?php echo $count['user']['space_url']; ?>" class="avatar-box pull-left">
										<span class="avatar-circle">
											<img class="mbm" src="<?php echo $count['user']['avatar_middle']; ?>" alt="<?php echo $count['user']['realname']; ?>">
										</span>
									</a>
									<div class="dib pull-right pc-info">
										<p class="xwb"><?php echo $count['user']['realname']; ?></p>
										<p class="tcm fss">累计<span class="xco fill-mm fst"><?php echo $count['count']; ?></span>次</p>
									</div>
								</div>
							</li>
						<?php endforeach; ?>
