<div style="width:493px; margin:0 auto;padding-bottom:15px;border-bottom:1px dashed #d7d4d4">
    <span style="width:330px; font-size:14px; font-weight:bold; color:#1180c6;"><?php echo $realname; ?>　<?php echo $date; ?>　工作日志</span>
</div>
...
<br>
<p style="font-weight:bold;font-size:14px; color:#50545f;"><?php echo $lang['Plan']; ?><span style="font-size:12px;">(<?php echo $plantime; ?>)</span></p>
