...
<div class="mc clearfix">
    ...
    <!-- Mainer right -->
    <form action="<?php echo $this->createUrl( 'default/edit' , array( 'op' => 'update' ) ); ?>" method="post" id="diary_form">
        <div class="mcr">
            <div class="page-list">
                <div class="fill-ss">
                    <div class="mini-date">
                ...
                <div class="page-list-mainer">
                    ...
                    <table class="da-detail-table">
                        <tbody id="da_complete">
                            ...
                            <?php endforeach; ?>
                            <input type="hidden" name="originalPlantime" value="<?php echo $data['originalPlanList'][0]['plantime']; ?>">
                        <?php } ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="min-height: 375px;">
                                        <script name="diaryContent" type="text/plain" id="editor"><?php echo $diary['content']; ?></script>
                                    </div>
                                </td>
                            </tr>
                            <!-- 附件 -->
                                ...
                                <td>
                                    <div class="att">
										<div class="attb">
                                            ...
                                            <input type="hidden" name="attachmentid" id="attachmentid" value="<?php echo $diary['attachmentid']; ?>">
										</div>
                                                ...
                                                <div class="attl-item" data-node-type="attachItem">
                    								...
                    								<span class="fss mlm">
                    									...
                    									<?php if (isset($value['officeediturl'])): ?>
                    										<a href="javascript:;" class="mlm" data-action="editOfficeFile" data-param='{"href": "<?php echo $value['officeediturl']; ?>"}' title="<?php echo $lang['Edit']; ?>">
                    											<?php echo $lang['Edit']; ?>
                    										</a>
                    									<?php endif; ?>
                    								</span>
                    ...
                    <div class="clearfix">
                        ...
                        <div class="input-operates date form_datetime hide" id="da_plan_date">
                            <input type="text" name="plantime" readonly="" value="<?php echo $diary['nextDiarytime']['year']; ?>-<?php echo $diary['nextDiarytime']['month']; ?>-<?php echo $diary['nextDiarytime']['day']; ?>">
                        </div>
                    </div>
                    <div class="posr">
                        <table class="da-detail-table">
		    ...
		    <!--默认共享-->
                    <?php if ( $dashboardConfig['sharepersonnel'] ): ?>
                        <div class="cti">
                            ...
                            <div class="row">
                                <div class="span9">
                                    <input type="text" name="shareuid" id="da_shared" value="<?php echo $diary['shareuid']; ?>">
                                </div>
                                <div class="span3">
        ...
        <td>
            <div class="fill-sn">
                <div class="pull-right">
                    ...
                    <input type="hidden" id="processinput_<%=id%>" name="planOutside[<%=id%>][schedule]" value='<%=schedule%>'/>
                </div>
                <span class="da-detail-num" data-toggle="badge"></span></span>
                <input type="text" name="planOutside[<%=id%>][content]" class="da-input span7" value="<%=subject%>" data-node-type="oldPlanInput" data-id="<%=id%>"  placeholder="点击写日志，按回车键换行">
            </div>
        </td>
    </tr>
</script>
        ...
        <td>
            <div class="da-plan-item fill <%=  range ? 'da-reminded': '' %>" data-node-type="planRow">
                ...
                <div class="posr">
                    ...
                    <input type="text" name="plan[<%=id%>][content]" class="da-input span7" value="<%=subject%>" data-node-type="newPlanInput" data-id="<%=id%>" placeholder="点击写计划，按回车键换行">
                </div>
            </div>
        </td>
    </tr>
