    ...
    <div class="mcr">
                ...
                <div class="usi-terse">
                    <div class="avatar-box">
                        ...
                        <?php if ($dashboardConfig['attention']): ?>
                            <a href="javascript:;" data-action="toggleAsterisk" class="o-da-asterisk"
        ...
        <div class="page-list">
            <div class="page-list-header">
                <form
                    action="<?php echo $this->createUrl('attention/index', array('op' => 'personal', 'param' => 'search', 'uid' => $user['uid'])); ?>"
                    method="post">
