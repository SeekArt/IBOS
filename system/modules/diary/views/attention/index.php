			...
			<div class="page-list">
				<div class="page-list-header">
					...
					<div class="btn-group pull-left mls">
						<a href="<?php echo $this->createUrl( 'attention/index', array( 'date' => 'yesterday' ) ) ?>" class="btn <?php $date = Env::getRequest( 'date' );
							if ( $date == 'yesterday' || !isset( $date ) ): ?>active<?php endif; ?>"><?php echo $lang['Yesterday']; ?></a>
                        <a href="<?php echo $this->createUrl( 'attention/index', array( 'date' => 'today' ) ) ?>" class="btn <?php $date = Env::getRequest( 'date' );
							if ( $date == 'today' ): ?>active<?php endif; ?>"><?php echo $lang['Today']; ?></a>                      
					</div>
					<div class="btn-group pull-right">
                        <a href="<?php echo $this->createUrl( 'attention/index', array( 'date' => $prevAndNextDate['prev'] ) ); ?>" class="btn">
								...
								<li class="da-list-item">
									<div class="da-summary">
										<div class="avatar-box">
											<a href="<?php echo $this->createUrl( 'attention/index', array( 'op' => 'personal', 'uid' => $diary['uid'] ) ) ?>" class="avatar-circle">
										...
										<div class="das-content">
											...
											<div class="da-list-item-desc">
												<div class="pull-right">
													<a href="<?php echo $this->createUrl( 'attention/show', array( 'diaryid' => $diary['diaryid'] ) ) ?>" target="_blank" class="o-more cbtn" title="<?php echo $lang['More']; ?>"></a>
												</div>
