                ...
                <tbody>
                    <tr>
                        <?php foreach ( $calendar as $key => $value ): ?>
                            ...
                            <?php endif; ?>
                            <td data-id="<?php echo $value['diaryid']; ?>" style="cursor:pointer;"><a data-id="<?php echo $value['diaryid']; ?>" href="javascript:" class="<?php echo $value['className']; ?>"><?php echo $value['day']; ?></a></td>
                            <?php if ( ($key + 1) % 7 == 0 ): ?>
                            </tr>
                            <tr>
                            <?php endif; ?>
        ...
        <div class="show">
            <table class="table table-underline">
                <tbody>
                    ...
                    <tr>
                        <td width="40">
                            <div class="avatar-box" data-toggle="usercard" data-param="uid=<?php echo $review['uid']; ?>">
...
<script>
    ...
    (function(){
        ...
        $("#remind_underling").on("click", function(){
            var $elem = $(this);
            $.post(Ibos.app.url('diary/review/edit', { op: 'remind'}), { uids: Ibos.app.g('subUids'), date: Ibos.app.g('date') } , function(res){
