    ...
    <div class="cmt" id="rep_<?php echo $rowid; ?>">
        ...
        <?php if (isset($allowComment) && $allowComment): ?>
            <div class="cmt-item" id="newCommentBox" data-node-type="commentBox">
                ...
                <div class="cmt-body">
                    <textarea id="commentBox" rows="3" class="mbs"
                              placeholder="<?php echo $lang['Say something...']; ?>"
                              data-node-type="commentText"></textarea>
                    <div class="mbs fss clearfix">
                        <a href="javascript:;" id="comment_emotion_<?php echo $rowid; ?>"
                           title="<?php echo $lang['Expression']; ?>" class="cbtn o-expression" data-act="face"
