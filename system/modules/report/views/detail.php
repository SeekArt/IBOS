...
<div class="rp-stamp">
    <span id="preview_stamp_<?php echo $report['repid']; ?>">
        <?php if ( !empty( $stampUrl ) ): ?>
            <img style="border:none"  id="stamp_<?php echo $report['repid']; ?>" src="<?php echo $stampUrl; ?>" width="150px" height="90px" />
        <?php endif; ?>
    </span>
</div>
<table class="rp-detail-table">
    <tbody>
        ...
        <?php if ( !empty( $attachs ) ): ?>
            <tr>
                <th class="sep" width="68"><?php echo $lang['Attachement']; ?><br /><?php echo count( $attachs ); ?><?php echo $lang['Individual']; ?></th>
                <td class="sep" width="3"></td>
                <td>
