                    ...
                    <div class="usi-terse">
                        <a href="" class="avatar-box">
                            <span class="avatar-circle">
                                <img class="mbm"
                                     src="<?php echo Org::getDataStatic($user['uid'], 'avatar', 'middle') ?>" alt="">
                            </span>
                        </a>
            ...
            <div class="page-list">
                <div class="page-list-header">
                    <div class="btn-toolbar pull-left">
                        <a href="<?php echo $this->createUrl('default/add', array('typeid' => $typeid)); ?>"
                           class="btn btn-primary"><?php echo $lang['Write report']; ?></a>
                        ...
                        <?php foreach ($reportList as $k => $report): ?>
                            <li class="rp-list-item">
                                <div class="rp-summary">
                                    <a href="<?php echo $this->createUrl('default/show', array('repid' => $report['repid'])); ?>"
                                       class="rp-weekly">
                                    ...
                                    <div class="rps-content">
                                        ...
                                        <div class="rp-list-item-desc clearfix">
                                            <div class="pull-right">
                                                ...
                                                <a href="javascript:;" data-action="removeReportFromList"
                                                   data-param='{"id": "<?php echo $report['repid']; ?>"}'
                                                   class="o-trash cbtn mls" title="<?php echo $lang['Delete']; ?>"></a>
                                            </div>
                                            <label class="checkbox checkbox-inline">
                                                <input type="checkbox" name="report[]"
                                                       value="<?php echo $report['repid']; ?>">
                                            </label>
