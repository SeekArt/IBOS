...
<div class="wrap">
    <div class="mc clearfix">
        ...
        <!-- Mainer right -->
        <form action="<?php echo $this->createUrl('default/add', array('op' => 'save')); ?>" id="report_form"
              method="post">
            <div class="mcr">
                <div class="page-list">
                    <div class="ctform">
                    ...
                    <div class="page-list-mainer">
                        <table class="rp-detail-table">
                                        ...
                                        <div class="pull-right">
                                            <div class="calendar-group pull-left">
                                                <div class="datepicker form_datetime" id="date_summary_start"
                                                     data-value="<?php echo $summaryAndPlanDate['summaryBegin']; ?>">
                                                    <a href="javascript:;" class="datepicker-btn"></a>
                                                    <input type="text" class="datepicker-input" id="summary_start_time"
                                                           name="begindate"
                                                           value="<?php echo $summaryAndPlanDate['summaryBegin']; ?>">
                                                </div>
                                                <span class="sep"><?php echo $lang['To']; ?></span>
                                                <div class="datepicker form_datetime" id="date_summary_end">
                                                    <a href="javascript:;" class="datepicker-btn"></a>
                                                    <input type="text" class="datepicker-input" id="summary_end_time"
                                                           name="enddate"
                                                           value="<?php echo $summaryAndPlanDate['summaryEnd']; ?>">
                                                </div>
                                            </div>
                                            <div class="btn-group ml">
                                                <button type="button" class="btn" id="date_summary_prev"
                                                        data-action="prevSummaryDate"
                                                        data-param='{"type": "<?php echo $intervaltype; ?>", "intervals": "<?php echo $intervals; ?>" }'>
                                                ...
                                                <li class="np-list-row">
                                                    <div class="bamboo-pgb pull-right">
                                                        <span class="pull-left xcn fss"
                                                              id="processbar_info_<?php echo $orgPlan['recordid'] ?>">100%</span>
                                                    ...
                                                    <span class="rp-detail-num" data-toggle="badge"><?php echo $k + 1 ?>
                                                        .</span> <?php echo $orgPlan['content']; ?>
                                                    <div class="rp-exec-status">
                                                        <input type="text"
                                                               name="orgPlan[<?php echo $orgPlan['recordid'] ?>][exedetail]"
                                                               class="input-small span7"
                                                               placeholder="<?php echo $lang['Implementation for click typing']; ?>">
                                                    </div>
                                                </li>
                                            <?php endforeach; ?>
                                        </ul>
                                        ...
                                        <div class="pull-right">
                                            <div class="calendar-group pull-left">
                                                <div class="datepicker form_datetime" id="date_plan_start"
                                                     data-value="<?php echo $summaryAndPlanDate['planBegin']; ?>">
                                                    <a href="javascript:;" class="datepicker-btn"></a>
                                                    <input type="text" class="datepicker-input" id="plan_start_time"
                                                           name="planBegindate"
                                                           value="<?php echo $summaryAndPlanDate['planBegin']; ?>">
                                                </div>
                                                <span class="sep"><?php echo $lang['To']; ?></span>
                                                <div class="datepicker form_datetime" id="date_plan_end">
                                                    <a href="javascript:;" class="datepicker-btn"></a>
                                                    <input type="text" class="datepicker-input" id="plan_end_time"
                                                           name="planEnddate"
                                                           value="<?php echo $summaryAndPlanDate['planEnd']; ?>">
                                                </div>
                                            </div>
                                            <div class="btn-group ml">
                            ...
                            <tr>
                                <th width="68" class="sep"><?php echo $lang['Work']; ?><br/><?php echo $lang['Plan'] ?>
                                </th>
                                <td width="3" class="sep"></td>
                                <td>
...
<script type="text/template" id="tpl_rp_new_plan">
    <li class="np-list-row" data-id="<%= id %>">
        ...
        <div class="posr">
            ...
            <span class="rp-detail-num" data-toggle="badge"><%= index %></span>
            <input type="text" name="nextPlan[<%= id %>][content]" class="rp-input span7" data-id="<%= id %>"
                   placeholder="<%= Ibos.l('RP.CLICK_TO_WRITE_PLAN') %>">
        </div>
    </li>
</script>
<script>
