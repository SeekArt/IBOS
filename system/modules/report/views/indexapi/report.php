            ...
            <?php foreach ($reports as $report): ?>
                <tr>
                    ...
                    <td width="20" style="text-align:right;">
                        <?php if (!empty($report['iconUrl'])): ?><img src="<?php echo $report['iconUrl']; ?>"
                                                                      alt=""><?php endif; ?>
                    </td>
                </tr>
            <?php endforeach; ?>
                ...
                <tr>
                    <td width="40">
                        <div class="avatar-box" data-toggle="usercard"
                             data-param="uid=<?php echo $subReport['uid']; ?>">
                    ...
                    <td width="60" style="text-align:right;">
                        <?php if (!empty($subReport['iconUrl'])): ?><img src="<?php echo $subReport['iconUrl']; ?>"
                                                                         alt=""><?php endif; ?>
                    </td>
                </tr>
            <?php endforeach; ?>
