                        ...
                        <div class="control-group">
                            <div class="controls">
                                <select name="pointsystem" id="point_sys" class="span6">
                                    <option value="10"
                                            <?php if ($config['pointsystem'] == 10): ?>selected<?php endif; ?>><?php echo $lang['Ten point scale']; ?></option>
                                    <option value="5"
                                            <?php if ($config['pointsystem'] == 5): ?>selected<?php endif; ?>><?php echo $lang['Five point scale']; ?></option>
                                    <option value="3"
                                            <?php if ($config['pointsystem'] == 3): ?>selected<?php endif; ?>><?php echo $lang['Three point scale']; ?></option>
                                </select>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <label class="checkbox pull-right"
                                                   title="<?php //echo $lang['Autoreview tip'];  ?>"><input
                                                    type="checkbox" name="autoreview" id="auto_apprise"
                                                    value="1"><?php echo $lang['Auto comment']; ?></label>
                                        </th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="stamp-slot" data-node-type="stampSlot">
                                                            <div class="stamp-item ui-draggable"
                                                                ...
                                                                <img
                                                                    src="<?php echo File::fileName(Stamp::model()->fetchIconById($stampId)); ?>"
                                                    ...
                                                    <td>
                                                        <label class="radio pull-right" style="display: none;"><input
                                                                ...
                                                                <?php if ($config['autoreviewstamp'] == $stampId): ?>checked<?php endif; ?>></label>
                                                    </td>
                                                </tr>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
                                            ...
                                            <div id="stamp_item_box" class="stamp-item-box">
                                                <?php foreach ($diffStampIds as $key => $diffStampId): ?>
                                                    <div class="stamp-item" data-node-type="stampItem"
                                                        ...
                                                        <img
                                                            src="<?php echo File::fileName(Stamp::model()->fetchIconById($diffStampId)); ?>"
                                                            alt="" width="60" height="24">
                                                    </div>
                                                <?php endforeach; ?>
                                            </div>
...
<script
    src="<?php echo Ibos::app()->assetManager->getAssetsUrl('report'); ?>/js/report_dashboard_index.js?<?php echo VERHASH; ?>"></script>
<script>
