			...
			<div class="ctb">
				...
				<div class="ctbw">
					<div class="control-group">
						...
						<div class="controls">
							<input type="checkbox" name="votethumbenable" value='1' id="thumb_operate" data-toggle="switch" class="visi-hidden" <?php if ( $votethumbenable ): ?>checked<?php endif; ?>>
						</div>
					</div>
					<div class="control-group thumb-operate" style="<?php if ( $votethumbenable ): ?>display:block<?php endif; ?><?php if ( !$votethumbenable ): ?>display:none<?php endif; ?>">
						<label for="" class="control-label"><?php echo $lang['Thumbnail size']; ?></label>
						<div class="controls">
							<input type="text" class="span3" name="votethumbwidth" value='<?php echo $votethumbwidth; ?>'> &nbsp; X &nbsp; <input type="text" class="span3" name="votethumbheight" value='<?php echo $votethumbheight; ?>'>
						</div>
					</div>
					<div class="control-group">
