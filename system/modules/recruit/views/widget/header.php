...
<div class="clearfix">
	...
	<div class="span3">
		<div class="datepicker input-group" id="start_time">
			...
			<input type="text" class="datepicker-input" id="range_start" value="<?php echo date( 'Y-m-d', $time['start'] ); ?>">
		</div>
	</div>
	<div class="span3">
		<div class="datepicker input-group" id="end_time">
			...
			<a href="javascript:;" class="datepicker-btn"></a>
			<input type="text" class="datepicker-input" id="range_end" value="<?php echo date( 'Y-m-d', $time['end'] ); ?>">
		</div>
	</div>
...
<script type="text/javascript">
	...
	$("#start_time, #end_time").on("hide", function(){
		...
		if(startTime && endTime){
			window.location.href = Ibos.app.url('<?php echo $timeRoute; ?>', {start: startTime, end: endTime, module: '<?php echo $module; ?>'});
		}
	})
