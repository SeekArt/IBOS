			...
			<div class="page-list">
				<div class="page-list-header">
					<div class="btn-toolbar pull-left">
						<button class="btn btn-primary pull-left" data-action="addBgcheck"><?php echo $lang['Add']; ?></button>
						...
						<tbody id="bgchecks_tbody">
							<?php foreach ( $resumeBgchecksList as $bgchecks ) : ?>
								<tr>
									...
									<td>
										<a href="javascript:" data-action="editBgcheck" data-id="<?php echo $bgchecks['checkid']; ?>" title="<?php echo $lang['Modify'] ?>" class="cbtn o-edit"></a>
									</td>
								</tr>
							<?php endforeach; ?>
						</tbody>
					</table>
					<div class="no-data-tip" <?php if( count( $resumeBgchecksList ) >0 ): ?> style="display:none" <?php endif; ?> id="no_bgchecks_tip"></div>
                </div>
