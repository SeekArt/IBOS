...
<div class="wrap">
    <div class="mc clearfix">
        ...
        <!-- Mainer right -->
        <div class="mcr">
            <form action="<?php echo $this->createUrl( 'resume/add', array('op'=>'save') ); ?>" method="post" class="form-horizontal" id="resume_form">
                <!-- 基本信息 start -->
                                ...
                                <div class="span6" data-expand-target="recruitsex" <?php if( !$dashboardConfig['recruitsex']['visi'] ): ?>style="display: none;"<?php endif; ?>>
                                    ...
                                    <div class="controls">
                                        <label class="radio radio-inline checked"><span class="icon"></span><span class="icon-to-fade"></span>
                                                <input id="recruitsex" type="radio" name="gender" value="1" checked="checked"><?php echo $lang['Male']; ?></label>&nbsp;
                                        <label class="radio radio-inline"><span class="icon"></span><span class="icon-to-fade"></span>
                                                <input id="recruitsex" type="radio" name="gender" value="2" ><?php echo $lang['Female']; ?></label>&nbsp;
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="span6" data-expand-target="recruitbirthday" <?php if( !$dashboardConfig['recruitbirthday']['visi'] ): ?>style="display: none;"<?php endif; ?>>
                                    <div class="control-group">
                                        ...
                                        <div class="datepicker" id="date_time">
                                            ...
                                            <input type="text" id="recruitbirthday" name="birthday" class="datepicker-input">
                                        </div>
                                    </div>
                                </div>
                                <!-- 籍贯 -->
                        ...
                        <div class="span4" data-expand-target="recruitmaritalstatus" <?php if( !$dashboardConfig['recruitmaritalstatus']['visi'] ): ?>style="display: none;"<?php endif; ?>>
                            ...
                            <div>
								<label class="radio radio-inline">
                                    <input id="recruitmaritalstatus" type="radio" name="maritalstatus" value="0" checked>
                    ...
                    <div class="row">
                        ...
                        <div class="span12" data-expand-target="recruitworkexperience" <?php if( !$dashboardConfig['recruitworkexperience']['visi'] ): ?>style="display: none;"<?php endif; ?>>
                            <div class="control-group">
                                ...
                                <textarea id="recruitworkexperience" name="workexperience" rows="4" cols="20"></textarea>
                            </div>
                        </div>
                        <!-- 项目经验 -->
                        <div class="span12" data-expand-target="recruitprojectexperience" <?php if( !$dashboardConfig['recruitprojectexperience']['visi'] ): ?>style="display: none;"<?php endif; ?>>
                            <div class="control-group">
                                ...
                                <textarea id="recruitprojectexperience" name="projectexperience" rows="4" cols="20"></textarea>
                            </div>
                        </div>
                        <!-- 教育背景 -->
                        ...
                        <div class="span12" data-expand-target="recruitprofessionskill" <?php if( !$dashboardConfig['recruitprofessionskill']['visi'] ): ?>style="display: none;"<?php endif; ?>>
                            <div class="control-group">
                                ...
                                <textarea id="recruitprofessionskill" name="professionskill" rows="4" cols="20"></textarea>
                            </div>
                        </div>
                        <!-- 培训经历 -->
                            <div class="span12" data-expand-target="recruittrainexperience" <?php if( !$dashboardConfig['recruittrainexperience']['visi'] ): ?>style="display: none;"<?php endif; ?>>
                                <div class="control-group">
                                    ...
                                    <textarea id="recruittrainexperience" name="trainexperience" rows="4" cols="20"></textarea>
                                </div>
                            </div>
                        <!-- 自我评价 -->
                        <div class="span12" data-expand-target="recruitselfevaluation" <?php if( !$dashboardConfig['recruitselfevaluation']['visi'] ): ?>style="display: none;"<?php endif; ?>>
                            <div class="control-group">
                                ...
                                <textarea id="recruitselfevaluation" name="selfevaluation" rows="4" cols="20"></textarea>
                            </div>
                        </div>
                        <!-- 相关证书 -->
                        <div class="span12" data-expand-target="recruitrelevantcertificates" <?php if( !$dashboardConfig['recruitrelevantcertificates']['visi'] ): ?>style="display: none;"<?php endif; ?>>
                            <div class="control-group">
                                ...
                                <textarea id="recruitrelevantcertificates" name="relevantcertificates" rows="4" cols="20"></textarea>
                            </div>
                        </div>
                        <!-- 社会实践 -->
						<div class="span12" data-expand-target="recruitsocialpractice" <?php if( !$dashboardConfig['recruitsocialpractice']['visi'] ): ?>style="display: none;"<?php endif; ?>>
							<div class="control-group">
								...
								<textarea id="recruitsocialpractice" name="socialpractice" rows="4" cols="20"></textarea>
							</div>
						</div>
					</div>
                    <!-- Row 14 -->
                ...
                <div id="submit_bar" class="fill clearfix">
                    <div class="pull-right">
                        <button type="submit" class="btn btn-large btn-submit btn-primary" id="save_resume"><?php echo $lang['Save']; ?></button>
                    </div>
                </div>
            </form>	
        </div>
