                ...
                <div class="ct ctform cti">
                    ...
                    <div class="well well-full">
                        <div class="mal-form">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="" name="emailbody[towebmail]" class="span12"
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <div class="btn-group btn-group-inverse">
                                            <ul class="dropdown-menu" data-toggle="imitate-select"
                                                data-input="#web_mail">
                                                <?php $firstIndex = true; ?>
                                                <?php foreach ($emailWebList as $emailWeb): ?>
                                                    <li <?php if ($firstIndex): ?>class="active"<?php endif; ?>
                                                        data-value="<?php echo $emailWeb['webid']; ?>">
                                                        <a href="javascript:;"><?php echo $emailWeb['address']; ?></a>
                                                    </li>
                                                    <input type="hidden"
                                                           <?php if ($firstIndex): ?>value="<?php echo $emailWeb['webid']; ?>"<?php endif; ?>
                                                           name="emailbody[fromwebid]" id="web_mail">
                                                    <?php
                                                    if ($firstIndex) {
                                            ...
                                            <a target="_blank"
                                               href="<?php echo Yii::app()->createUrl('email/default/webemail', array('uid' => Ibos::app()->user->uid)); ?>"
                            ...
                            <div class="control-group">
                                <div class="control-label control-label-btn btn-group">
                                    ...
                                    <ul id="mal_level_list" class="dropdown-menu xal" data-toggle="imitate-select"
                                        data-input="#mal_level">
                                ...
                                <div class="controls">
                                    <input type="text" name="emailbody[subject]"
                                           placeholder="<?php echo $lang['Please enter a message subject']; ?>"
                                           id="mal_title"
                                           value="">
                                </div>
                            </div>
                        ...
                        <div class="att">
                            <div class="attb">
                                ...
                                <a href="javascript:;" class="btn btn-icon vat"
                                   title="<?php echo $lang['Choose from a file cabinet']; ?>">
                    ...
                    <div id="submit_bar" class="clearfix">
                        ...
                        <div class="pull-right">
                            <button type="submit" name="emailbody[issend]" value="1"
                                    class="btn btn-large btn-submit btn-primary"><?php echo $lang['Send']; ?></button>
                        </div>
                    </div>
                </div>
