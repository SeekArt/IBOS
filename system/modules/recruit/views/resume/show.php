        ...
        <div class="mcr">
            ...
            <div class="ct ctview ct-affix">
                <div class="btn-toolbar noprint" data-spy="affix" data-offset-top="70">
                    <div class="btn-group">
                        <a href="<?php echo $this->createUrl( 'resume/edit', array( 'resumeid' => $resumeDetail['resumeid'] ) ); ?>" class="btn btn-primary pull-left"><?php echo $lang['Edit']; ?></a>
                    </div>
                    <div class="btn-group">
                ...
                <div>
                    <div id="resume_detail">
                        ...
                        <div class="bglb bdpt bdbs fill clearfix">
                            <div class="pull-left">
                                <div class="rsm-avt">
									<img <?php if(!empty($resumeDetail['avatarUrl'])): ?> src="<?php echo $resumeDetail['avatarUrl']; ?>" <?php elseif($resumeDetail['gender'] == '女'): ?> class="rsm-avt-female" <?php else: ?> class="rsm-avt-male" <?php endif; ?> height="156" width="108" />
                                </div>
                            </div>
                            <div class="rsm-psn-info">
                                <div class="rsm-psn-header">
                                    ...
                                    <a href="javascript:;" class="pull-right fss noprint" data-action="togglePersonalDetail"><?php echo $lang['View complete details']; ?><i class="caret caret-small vam mls"></i></a>
                                </div>
                                <div>
                                    <table class="rsm-psn-table" id="rsm_psn_table">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="line-height: 40px"><?php echo  $resumeDetail['mobile']; ?><i class="o-rsm-phone pull-right"></i></td>
                                                <th><?php echo $lang['Mail']; ?></th>
                                                <td style="line-height: 40px"><?php echo  $resumeDetail['email']; ?><i class="o-rsm-email pull-right"></i></td>
                                            </tr>
                        ...
                        <div class="fill">
        					<div class="alternate-bar noprint">
        						<a href="javascript:;" class="btn" data-action="expandAll" data-expand-all="resume_detail">+</a>
        						<a href="javascript:;" data-action="expandItem" data-expand="recruitlangskill"> <?php echo $lang['Language skills']; ?></a>
                                <span>/</span>
        						<a href="javascript:;" data-action="expandItem" data-expand="recruitcomputerskill"> <?php echo $lang['IT skills']; ?></a>
                                <span>/</span>
        						<a href="javascript:;" data-action="expandItem" data-expand="recruitprofessionskill"> <?php echo $lang['Vocational skills']; ?></a>
                                <span>/</span>
        						<a href="javascript:;" data-action="expandItem" data-expand="recruittrainexperience"> <?php echo $lang['Training experience']; ?></a>
                                <span>/</span>
        						<a href="javascript:;" data-action="expandItem" data-expand="recruitselfevaluation"> <?php echo $lang['Self-evaluation']; ?></a>
                                <span>/</span>
        						<a href="javascript:;" data-action="expandItem" data-expand="recruitrelevantcertificates"> <?php echo $lang['Relevant certificate']; ?></a>
                                <span>/</span>
        						<a href="javascript:;" data-action="expandItem" data-expand="recruitsocialpractice"> <?php echo $lang['Social practice']; ?></a>
							</div>
                        ...
                        <div class="noprint">
                            ...
                            <div class="field-title">
                                <h4><?php echo $lang['Attachment']; ?>（<?php echo count( $resumeDetail['attach'] ); ?><?php echo $lang['Piece']; ?>）</h4>
                            </div>
							<div class="fill">
								<ul class="attl">
                        ...
                        <div>
                            ...
                            <div class="nav-content bdrb tab-content">
                                ...
                                <div id="contact_record" class="tab-pane active">
                                    <div class="page-list">
                                        <div class="page-list-header">
                                            <button class="btn btn-primary" data-action="addContact"><?php echo $lang['Add']; ?></button>
                                            <button class="btn" data-action="deleteContacts"><?php echo $lang['Delete']; ?></button>
                                            <button class="btn" data-action="exportContact"><?php echo $lang['Export']; ?></button>
                                        </div>
                                                    ...
                                                    <tr>
                                                        <th width="20">
                                                            <label class="checkbox">
                                                                <input type="checkbox" name="" data-name="contact[]" id="contact_all_select">
                                                            </label>
                                                        </th>
                                                ...
                                                <tbody id="contact_tbody">
                                                    <?php foreach ( $contactList as $contact ) : ?>
                                                        <tr>
                                                            <td>
                                                                <label class="checkbox">
                                                                    <input type="checkbox" name="contact[]" value="<?php echo $contact['contactid']; ?>">
                                                                </label>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <a href="javascript:" data-action="editContact" data-id="<?php echo $contact['contactid']; ?>" title="<?php echo $lang['Update']; ?>" class="cbtn o-edit"></a>
                                                                <a href="javascript:" data-action="deleteContact" data-id="<?php echo $contact['contactid']; ?>"  title="<?php echo $lang['Delete']; ?>" class="cbtn o-trash"></a>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                                </tbody>
                                            </table>
											<div class="no-data-tip" <?php if( count( $contactList ) >0 ): ?> style="display:none" <?php endif; ?> id="no_contact_tip"></div>
                                        </div>
                                    </div>
                                ...
                                <div id="interview_record" class="tab-pane ct">
                                    <div class="page-list">
                                        <div class="page-list-header">
                                            <button class="btn btn-primary" data-action="addInterview"><?php echo $lang['Add']; ?></button>
                                            <button class="btn" data-action="deleteInterviews"><?php echo $lang['Delete']; ?></button>
                                            <button class="btn" data-action="exportInterview"><?php echo $lang['Export']; ?></button>
                                        </div>
                                        <div class="page-list-mainer">
                                            <table class="table table-striped table-hover" id="interview_list">
                                                <thead>
                                                    <tr>
                                                        <th width="20">
                                                            <label class="checkbox">
                                                                <input type="checkbox" name="" data-name="interview[]" id="interview_all_select">
                                                            </label>
                                                        </th>
                                                ...
                                                <tbody id="interview_tbody">
                                                    <?php foreach ( $interviewList as $interview ) : ?>
                                                        <tr>
                                                            <td>
                                                                <label class="checkbox">
                                                                    <input type="checkbox" name="interview[]" value="<?php echo $interview['interviewid']; ?>">
                                                                </label>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <a href="javascript:" data-action="editInterview" data-id="<?php echo $interview['interviewid']; ?>" title="<?php echo $lang['Update']; ?>" class="cbtn o-edit"></a>
                                                                <a href="javascript:" data-action="deleteInterview" data-id="<?php echo $interview['interviewid']; ?>"  title="<?php echo $lang['Delete']; ?>" class="cbtn o-trash"></a>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                                </tbody>
                                            </table>
											<div class="no-data-tip" <?php if( count( $interviewList ) >0 ): ?> style="display:none" <?php endif; ?> id="no_interview_tip"></div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="backdrop_record" class="tab-pane">
                                    <div class="page-list">
                                        <div class="page-list-header">
                                            <button class="btn btn-primary" data-action="addBgcheck"><?php echo $lang['Add']; ?></button>
                                            <button class="btn" data-action="deleteBgchecks"><?php echo $lang['Delete']; ?></button>
                                            <button class="btn" data-action="exportBgcheck"><?php echo $lang['Export']; ?></button>
                                        </div>
                                        <div class="page-list-mainer">
                                            <table class="table table-striped table-hover" id="bgchecks_list">
                                                <thead>
                                                    <tr>
                                                        <th width="20">
                                                            <label class="checkbox">
                                                                <input type="checkbox" name="" data-name="bgcheck[]" id="bgcheck_all_select">
                                                            </label>
                                                        </th>
                                                ...
                                                <tbody id="bgchecks_tbody">
                                                    <?php foreach ( $bgcheckList as $bgcheck ) : ?>
                                                        <tr>
                                                            <td>
                                                                <label class="checkbox">
                                                                    <input type="checkbox" name="bgcheck[]" value="<?php echo $bgcheck['checkid']; ?>">
                                                                </label>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <a href="javascript:" data-action="editBgcheck" data-id="<?php echo $bgcheck['checkid']; ?>" title="<?php echo $lang['Update']; ?>" class="cbtn o-edit"></a>
                                                                <a href="javascript:" data-action="deleteBgcheck" data-id="<?php echo $bgcheck['checkid']; ?>"  title="<?php echo $lang['Delete']; ?>" class="cbtn o-trash"></a>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; ?>
                                                </tbody>
                                            </table>
											<div class="no-data-tip" <?php if( count( $bgcheckList ) >0 ): ?> style="display:none" <?php endif; ?> id="no_bgchecks_tip"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<tr>
    ...
    <td>
        <a href="javascript:" data-action="editContact" data-id="<%=contactid%>" title="<?php echo $lang['Update']; ?>" class="cbtn o-edit"></a>
        <a href="javascript:" data-action="deleteContact" data-id="<%=contactid%>"  title="<?php echo $lang['Delete']; ?>" class="cbtn o-trash"></a>
    </td>
</tr>
</script>
<!-- 插入面试信息模板 -->
...
<tr>
    ...
    <td>
        <a href="javascript:" data-action="editInterview" data-id="<%=interviewid%>" title="<?php echo $lang['Update']; ?>" class="cbtn o-edit"></a>
        <a href="javascript:" data-action="deleteInterview" data-id="<%=interviewid%>"  title="<?php echo $lang['Delete']; ?>" class="cbtn o-trash"></a>
    </td>
</tr>
</script>
<!-- 插入背景信息模板 -->
...
<tr>
    ...
    <td>
        <a href="javascript:" data-action="editBgcheck" data-id="<%=checkid%>" title="<?php echo $lang['Update']; ?>" class="cbtn o-edit"></a>
        <a href="javascript:" data-action="deleteBgcheck" data-id="<%=checkid%>"  title="<?php echo $lang['Delete']; ?>" class="cbtn o-trash"></a>
    </td>
</tr>
</script>
<script>
