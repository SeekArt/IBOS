                    ...
                    <span class="posr">
						...
						<ul class="dropdown-menu" id="task_op_menu">
                            <?php if ($isDesigneeuid): ?>
                                <li data-node="edit">
                                    <a href="javascript:;" data-action="openTaskEditDialog"
                                       data-param='{"id": <?php echo $assignment['assignmentid'] ?>}'><i
                                            class="o-menu-edit"></i> <?php echo $lang['Edit assignment']; ?></a>
                                </li>
                                <li data-node="remove">
                                    <a href="javascript:;" data-action="removeTaskInShow"
                                       data-param='{"id": <?php echo $assignment['assignmentid'] ?>}'><i
                                            class="o-menu-trash"></i> <?php echo $lang['Delete assignment']; ?></a>
                                </li>
                            <?php endif; ?>
                            <li data-node="restart">
                                <a href="javascript:;" data-action="restartTask"
                                   data-param='{"id": <?php echo $assignment['assignmentid'] ?>}'><i
                                        class="o-amm-loop"></i> <?php echo $lang['Restart assignment']; ?></a>
                            </li>
                            <li data-node="cancel">
                                <a href="javascript:;" data-action="cancelTask"
                                   data-param='{"id": <?php echo $assignment['assignmentid'] ?>}'><i
                                        class="o-amm-chi"></i> <?php echo $lang['Cancel assignment']; ?></a>
                            </li>
                            <li class="divider" style="margin: 0;"></li>
                            <li data-node="remind">
                                <a href="javascript:;" data-action="openRemindDialog"
                                   data-param='{"id": <?php echo $assignment['assignmentid'] ?>}'><i
                                        class="o-amm-clock"></i> <?php echo $lang['Set remind']; ?></a>
                            </li>
                            <li data-node="delay">
                                <a href="javascript:;" data-action="delayTask"
                                   data-param='{"id": <?php echo $assignment['assignmentid'] ?>}'><i
                                        class="o-amm-delay"></i> <?php echo $lang['Delay']; ?></a>
                            </li>
                        </ul>
					</span>
                <?php endif; ?>
            ...
            <div class="fill">
                ...
                <div>
                    <?php if ($participantCount > 0): ?>
                        <br/>
                        <p class="mbs">
                            <?php echo $lang['In addition to']; ?> <span
                                class="fsl"><?php echo $participantCount; ?></span> <?php echo $lang['Participate in the number of']; ?>
                            <br/>
                        </p>
...
<script type="text/template" id="tpl_delay_dialog">
    <form action="javascript:;">
        ...
        <textarea style="width: 300px; height: 100px;" name="reason"
                  placeholder="<%= U.lang('ASM.INPUT_TASK_DELAY_REASON')%>" class="mb"></textarea>
        <div class="input-group datepicker mb" id="task_delay_starttime">
            ...
            <input type="text" name="starttime" class="datepicker-input"
                   value="<?php echo date('Y-m-d H:i', $assignment['starttime']); ?>">
        </div>
        <div class="input-group datepicker mb" id="task_delay_endtime">
            ...
            <input type="text" name="endtime" class="datepicker-input"
                   value="<?php echo date('Y-m-d H:i', $assignment['endtime']); ?> ">
        </div>
    </form>
</script>
