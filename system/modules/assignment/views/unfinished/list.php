    ...
    <div class="mcr">
            ...
            <form action="javascript:;">
                <div class="am-publish-box shut">
                        ...
                        <div class="am-publish clearfix">
                            ...
                            <div class="amp-bar">
                                <div class="amp-bar-charge">
                                    <input type="text" id="am_bar_charge"
                                           value="<?php echo StringUtil::wrapId(Ibos::app()->user->uid); ?>">
                                </div>
                                <div class="amp-bar-endtime">
                                    <div class="input-group datepicker" id="am_bar_endtime">
                                        ...
                                        <input type="text" class="datepicker-input" id="am_bar_endtime_input"
                                               placeholder="<?php echo $lang['When to end']; ?>">
                                    </div>
                                </div>
                                <button type="button" class="o-am-plus" title="<?php echo $lang['Release']; ?>"
                    ...
                    <div class="am-publish-dt">
                        <div class="row mb">
                            <div class="span4">
                                <input type="text" name="chargeuid" id="am_charge"
                                       value="<?php echo StringUtil::wrapId(Ibos::app()->user->uid); ?>">
                            </div>
                            <div class="span4">
                                <div class="input-group datepicker pull-left" id="am_starttime">
                                    ...
                                    <a href="javascript:;" class="datepicker-btn"></a>
                                    <input type="text" class="datepicker-input" name="starttime" id="am_starttime_input"
                            ...
                            <div class="span4">
                                <div class="input-group datepicker pull-left" id="am_endtime">
                                    <span class="input-group-addon"><?php echo $lang['To']; ?></span>
                                    <a href="javascript:;" class="datepicker-btn"></a>
                                    <input type="text" class="datepicker-input" name="endtime" id="am_endtime_input"
                                           placeholder="<?php echo $lang['When to end']; ?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb">
                            <textarea name="description" rows="4" id="am_description"
                        ...
                        <div class="posr clearfix">
                            ...
                            <div class="pull-right">
                                ...
                                <button type="button" class="btn btn-primary"
                                        data-action="addTask"><?php echo $lang['Release']; ?></button>
                            </div>
                        </div>
            ...
            <div data-node-type="taskView">
                ...
                <div class="am-block mb" id="am_my_charge">
                    <div class="am-block-t">
                        <div class="am-pill"><i
                                class="o-ol-am-user"></i> <?php echo $lang['My responsible assignment']; ?></div>
                    </div>
                                    ...
                                    <tr data-id="<?php echo $charge['assignmentid']; ?>">
                                        <td width="22">
                                            <?php if ($charge['status'] == 4): ?>
                                                <a href="javascript:;" class="am-checkbox disabled"
                                                   data-id="<?php echo $charge['assignmentid']; ?>"></a>
                                            <?php else: ?>
                                                <a href="javascript:;" class="am-checkbox"
                                                   data-id="<?php echo $charge['assignmentid']; ?>"
                                                   title="<?php echo $lang['Finish'] ?>"></a>
                                            <?php endif ?>
                                        </td>
                                        <td width="36">
                                        ...
                                        <td width="110">
                                            ...
                                            <div class="am-item-op">
                                                ...
                                                <?php if ($charge['designeeuid'] == $charge['chargeuid']): ?>
                                                    <!-- 取消任务后不能再编辑 -->
                                                    <?php if ($charge['status'] != 4): ?>
                                                        <a href="javascript:;" class="o-edit mlm"
                                                           data-action="openTaskEditDialog"
                                                           data-param='{"id": <?php echo $charge['assignmentid']; ?> }'
                                                           title="<?php echo $lang['Edit']; ?>"></a>
                                                    <?php endif ?>
                                                    <a href="javascript:;" class="o-trash mlm" data-action="removeTask"
                                                       data-param='{"id": <?php echo $charge['assignmentid']; ?> }'
                ...
                <div class="am-block mb" id="am_my_designee">
                    <div class="am-block-t">
                        <div class="am-pill"><i class="o-ol-am-appoint"></i> <?php echo $lang['My assignments']; ?>
                        </div>
                    </div>
                    <div class="am-block-b">
                                    ...
                                    <tr data-id="<?php echo $designee['assignmentid']; ?>">
                                        <td width="22">
                                            <?php if ($designee['status'] == 0 || $designee['status'] == 4): ?>
                                                <a href="javascript:;" class="am-checkbox disabled"
                                                   data-id="<?php echo $designee['assignmentid']; ?>"></a>
                                            <?php else: ?>
                                                <a href="javascript:;" class="am-checkbox"
                                                   data-id="<?php echo $designee['assignmentid']; ?>"
                                                   title="<?php echo $lang['Finish'] ?>"></a>
                                            <?php endif ?>
                                        </td>
                                        <td width="36">
		...
		<!--												<img src="-->
                ...
                <div class="am-block mb" id="am_my_participant">
                    <div class="am-block-t">
                        <div class="am-pill"><i
                                class="o-ol-am-watch"></i> <?php echo $lang['I participate in the task']; ?></div>
                    </div>
                    <div class="am-block-b">
                                ...
                                <?php foreach ($participantData as $k => $participant): ?>
                                    <tr data-id="<?php echo $participant['assignmentid']; ?>">
                                        ...
                                        <td width="36">
											<span class="avatar-circle avatar-circle-small">
												<img
                                                    src="<?php echo !empty($participant['charge']['avatar_small']) ? $participant['charge']['avatar_small'] : 'data/avatar/noavatar_small.jpg'; ?>">
											</span>
                                        </td>
                                        <td>
...
<script type="text/template" id="tpl_task">
    <tr data-id="<%=id%>">
        <td width="22">
            <a href="javascript:;" class="am-checkbox <%= (typeof chargeself == 'undefined') ? 'disabled' : '' %>"
               data-id="<%=id%>" title="<?php echo $lang['Finish'] ?>"></a>
        </td>
        <td width="36">
    <span class="avatar-circle avatar-circle-small">
    ...
    <%= U.lang('ASM.UNREAD') %>
            ...
            <div class="am-item-op">
                ...
                <a href="javascript:;" class="o-edit mlm" data-action="openTaskEditDialog"
                   data-param='{"id": <%= id %> }' title="<?php echo $lang['Edit'] ?>"></a>
                <a href="javascript:;" class="o-trash mlm" data-action="removeTask" data-param='{"id": <%= id %> }'
                   title="<?php echo $lang['Delete'] ?>"></a>
                <% } %>
            </div>
        </td>
