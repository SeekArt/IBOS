...
class Chat extends Callback {
	...
	protected function retweetByImage( Push $handle ) {
		return $handle->sendImage( 'all', $this->getMediaId(), $this->getAppId() );
	}
	...
	protected function retweetByVoice( Push $handle ) {
		return $handle->sendVoice( 'all', $this->getMediaId(), $this->getAppId() );
	}
	...
	protected function retweetByVideo( Push $handle ) {
		return $handle->sendVideo( 'all', $this->getMediaId(), $this->getAppId() );
	}
