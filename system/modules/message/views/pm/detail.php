	...
	<div class="mcr">
		<div class="page-list" id="pm_list">
			<div class="page-list-header">
				<button type="button" onclick="location.href = '<?php echo $this->createUrl('pm/index'); ?>'" class="btn"><?php echo $lang['Return']; ?></button>
			</div>
			<div class="page-list-mainer">
					...
					<div class="band band-primary">
						...
						<div class="msg-pm-input msg-pm-input-fullmode" id="pm_input">
							<div class="msg-box msg-box-inverse mbs">
								...
								<textarea name="" id="reply_content" placeholder="<?php echo $lang['Sending to...']; ?><?php
							...
							<div class="msg-pm-input-operate clearfix">
								...
								<div class="pull-right">
									...
									<button type="button" class="btn btn-primary btn-widen" id="pm_submit" data-loading-text="<?php echo $lang['Sending ...']; ?>" disabled><?php echo $lang['Send']; ?></button>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="fill-sn">
					<button style="width: 100%;" class="btn" id="load_more_btn" data-loading-text="等待中..."><?php echo $lang['More']; ?></button>
				</div>
			</div>
		</div>
		<!-- Mainer content -->
