...
<li class="cmt-item">
	...
	<div class="cmt-body fss">
		...
		<div class="xar">
			<a href="javascript:;" data-act="reply" data-param='{"name":"<?php echo $userInfo['realname']; ?>","touid":"<?php echo $userInfo['uid']; ?>"}'><?php echo $lang['Reply']; ?></a>
			<?php if ( $isCommentDel ): ?>
				<a href="javascript:;" class="mls" data-act="delreply" data-param='{"cid":"<?php echo $cid; ?>"}'><?php echo $lang['Delete']; ?></a>
			<?php endif; ?>
		</div>
	</div>
</li>