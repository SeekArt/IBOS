	...
	<div class="cmt-body">
		...
		<div class="mbs fss">
			...
			<div class="pull-right">
				<a href="javascript:;" data-act="getreply" data-param='{"type":"reply","name":"<?php echo $userInfo['realname']; ?>","module":"message","table":"comment","rowid":"<?php echo $cid; ?>"}'><?php echo $lang['Reply']; ?>(0)</a>
				<a href="javascript:;" class="mls" data-act="delcomment" data-param='{"cid":"<?php echo $cid; ?>"}' class="mls"><?php echo $lang['Delete']; ?></a>
			</div>
		</div>
		<div class="well well-small well-lightblue" style="display: none;">
			<textarea class="mbs reply"><?php echo $lang['Reply']; ?> <?php echo '@' . $userInfo['realname']; ?> ：</textarea>
			<div class="clearfix">
				<button type="button" data-tocid="<?php echo $cid; ?>" data-touid="<?php echo $userInfo['uid']; ?>" class="btn btn-primary btn-small pull-right" data-act="addreply" data-loading-text="<?php echo $lang['Reply ing']; ?>..." data-param='{"type":"reply","rowid":"<?php echo $cid; ?>","table":"comment","module":"message","moduleuid":"<?php echo $uid; ?>"}'><?php echo $lang['Reply']; ?></button>
			</div>
			<ul class="cmt-sub"></ul>
		</div>
		<div>
