    ...
    <body>
        ...
        <div class="wb-rep">
            <div class="wb-at-someone">
                <a href="<?php echo $sourceInfo['source_user_info']['space_url']; ?>" class="wb-source">@<?php echo $sourceInfo['source_user_info']['realname'] ?></a>
            </div>
                    ...
                    <?php if ( $sourceInfo['has_attach'] ): ?>
                        <?php foreach ( $sourceInfo['attach'] as $att ): ?>
                            <div class="wb-info-pic">
                                <a href="<?php echo $att['attach_url'] ?>" data-lightbox="preview" title="<?php echo $att['attach_name'] ?>">
                                    <img src="<?php echo $att['attach_middle']; ?>" alt="<?php echo $att['attach_name'] ?>">
                                </a>
                                <div class="wb-info-pic-tip">
                                    <div class="wb-info-pic-tipbg"></div>
                                    <a href="<?php echo $att['attach_url'] ?>" data-lightbox="preview" title="<?php echo $att['attach_name'] ?>">点击查看完整图片</a>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    <?php endif; ?>
