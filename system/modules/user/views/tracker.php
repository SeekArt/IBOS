...
<div class="dib right-sidebar">
	...
	<div class="sidebar-body">
		<div class="mb clearfix">
			<div class="pull-left"><?php if ( $percent == 100 ): ?>亲，记得及时更新哦！<?php else: ?>赶快来完善一下资料吧！<?php endif; ?></div>
		...
		<div class="progress mb">
			<div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="<?php echo $percent; ?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $percent; ?>%;"></div>
		</div>
		<?php if ( $percent !== 100 ): ?>
