...
<html lang="en">
	...
	<body>
		<div class="wrap clearfix">
			<div>
				<div class="fill">
					<form onsubmit="return checkpass()" action="<?php echo $this->createUrl( 'default/reset' ); ?>" method="post" class="form-horizontal form-narrow">
						<div class="data-title mb">
							<i class="o-change-password"></i><span class="fsl vam">你好，<?php echo $user; ?>。系统已设置密码过期保护。您的密码已过期，请先修改密码</span>
						</div>
						<div class="control-group">
							<label class="control-label"><?php echo $lang['Original password']; ?><span class="xcr">*</span></label>
							<div class="controls">
						...
						<div class="control-group">
							<div class="controls">
								...
								<input type="submit" value="<?php echo $lang['Submit']; ?>" class="btn btn-primary btn-large btn-great" />
							</div>
						</div>
					</form>
				</div>
