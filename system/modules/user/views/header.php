...
<div class="pc-banner">
    ...
    <?php if ($this->getIsMe()): ?><a href="javascript:;" id="skin_choose"
                                      title="<?php echo $lang['Custom banner']; ?>"></a><?php endif; ?>
</div>
<div class="pc-usi">
    <div class="pc-usi-bg"></div>
    <?php if ($this->getIsMe()): ?>
        <a href="<?php echo Ibos::app()->createUrl('user/home/personal', array('op' => 'avatar', 'uid' => $user['uid'])); ?>"
           class="pc-usi-avatar posr">
            <img src="<?php echo Ibos::app()->user->avatar_big ?>" alt="<?php echo $user['realname']; ?>" width="180"
                 height="180"/>
    ...
    <?php else: ?>
        <span class="pc-usi-avatar posr">
            <img src="<?php echo $user['avatar_big']; ?>" alt="<?php echo $user['realname']; ?>" width="180"
                 height="180"/>
        </span>
    <?php endif; ?>
    <?php if (Ibos::app()->user->uid !== $user['uid']): ?>
        <a href="javascript:Ibos.showPmDialog('<?php echo StringUtil::wrapId($user['uid'], 'u'); ?>');void(0);"
           class="private-letter" title="<?php echo $lang['Send message']; ?>">
    ...
    <div class="pc-usi-sign clearfix">
        <div class="pull-left">
            <?php if ($this->getIsMe()): ?>
                <a href="<?php echo Ibos::app()->createUrl('user/home/personal', array('uid' => $user['uid'])); ?>"
                   class="btn btn-small"><?php echo $lang['Edit profile']; ?></a>
            <?php else: ?>
                <!-- 关注的几种状态 -->
            ...
            <ul class="list-inline pc-info-list">
                <li class="ml">
                    <a href="<?php echo Ibos::app()->urlManager->createUrl('weibo/personal/following', array('uid' => $user['uid'])); ?>">
                        <strong
                            class="xcbu fsl"><?php echo isset($userData['following_count']) ? $userData['following_count'] : 0; ?></strong>
                ...
                <li class="ml">
                    <a href="<?php echo Ibos::app()->urlManager->createUrl('weibo/personal/follower', array('uid' => $user['uid'])); ?>">
                        <strong
                            class="xcbu fsl"><?php echo isset($userData['follower_count']) ? $userData['follower_count'] : 0; ?></strong>
                ...
                <li class="ml">
                    <a href="<?php echo Ibos::app()->urlManager->createUrl('weibo/personal/index', array('uid' => $user['uid'])); ?>">
                        <strong
                            class="xcbu fsl"><?php echo isset($userData['weibo_count']) ? $userData['weibo_count'] : 0; ?></strong>
    ...
    <div class="skin-type-choose tab-content">
        ...
        <div id="skin_custom" class="bg-choose mark tab-pane model-skin">
            <div class="user-defined-bg mark">
                <form action="<?php echo Ibos::app()->urlManager->createUrl('user/skin/cropBg'); ?>" method="post"
                      id="skin" class="update-pic cf">
