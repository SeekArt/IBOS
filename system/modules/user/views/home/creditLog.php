...
<div class="pc-header clearfix">
    <ul class="nav nav-skid">
		...
		<li><a href="<?php echo $this->createUrl( 'home/credit', array( 'op' => 'rule', 'uid' => $this->getUid() ) ); ?>"><?php echo $lang['Rule']; ?></a></li>
	</ul>
</div>
<div>
			...
			<div class="page-list clearfix">
				<div class="page-list-header clearfix">
					<div class="btn-group" id="points_record_tab">
						<a href="javascript:;" data-target="#reward" class="btn active"><?php echo $lang['System reward']; ?></a>
						<a href="javascript:;" data-target="#income" class="btn"><?php echo $lang['Integral benefits']; ?></a>
					</div>
				</div>
