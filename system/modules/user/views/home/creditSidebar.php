				...
				<tr>
					<td colspan="2">
						<div class="xar">
							...
							<a href="javascript:;" id="integral_tip" data-placement="bottom" data-html="true" data-original-title="<?php echo $lang['Credit total']; ?> = <?php echo $creditFormulaExp; ?>"><?php echo $lang['Credit formula']; ?></a>
						</div>
					</td>
				</tr>
			</tfoot>
