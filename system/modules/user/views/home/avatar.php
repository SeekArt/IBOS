				...
				<div class="mb">
					...
					<div class="preview-area">
						...
						<div class="crop crop180">
							<img id="crop-preview-180" src="static.php?type=avatar&uid=<?php echo $user['uid']; ?>&size=big&engine=<?php echo ENGINE; ?>&random=<?php echo $random; ?>" />
						</div>
						<p class="tcm fss size-tip">180*180<?php echo $lang['Pixel']; ?></p>
						<div class="crop crop60">
							<img id="crop-preview-60" src="static.php?type=avatar&uid=<?php echo $user['uid']; ?>&size=middle&engine=<?php echo ENGINE; ?>&random=<?php echo $random; ?>" />
						</div>
						<p class="tcm fss size-tip">60*60<?php echo $lang['Pixel']; ?></p>
						<div class="crop crop30">
							<img id="crop-preview-30" src="static.php?type=avatar&uid=<?php echo $user['uid']; ?>&size=small&engine=<?php echo ENGINE; ?>&random=<?php echo $random; ?>" />
						</div>
