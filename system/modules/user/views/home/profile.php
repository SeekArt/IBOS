...
<div class="clearfix">
    <?php if ($this->getIsMe()): ?>
        <div class="pc-container clearfix dib left-sidebar">
            <div>
                <form id="profile_form" action="<?php echo $this->createUrl('home/personal'); ?>" method="post"
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" value="<?php echo $user['mobile']; ?>" id="mobile" name="mobile"
                                   class="span7"<?php if ($user['validationmobile'] == 1): ?> disabled <?php endif; ?> >
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label"><?php echo $lang['Email']; ?></label>
                        <div class="controls">
                            <input type="text" value="<?php echo $user['email']; ?>" id="email" name="email"
                                   class="span7"<?php if ($user['validationemail'] == 1): ?> disabled<?php endif; ?> >
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" value="<?php echo $user['telephone']; ?>" name="telephone"
                                   class="span7"/>
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        <div class="controls">
                            ...
                            <input type="submit" name="userSubmit" value="<?php echo $lang['Save']; ?>"
                                   class="btn btn-large btn-primary btn-great"/></div>
                    </div>
                </form>
            </div>
        </div>
            ...
            <form action="" method="post" class="form-horizontal form-narrow">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <div class="controls-content">
                            <span
                                class="tcm"><?php if ($user['birthday'] > 0) :echo date('Y-m-d', $user['birthday']);endif; ?></span>
                        </div>
                    </div>
                </div>
                <div class="control-group">
...
<script>
    ...
    $(function () {
        ...
        var ajaxValidateSettings = {
            ...
            dataType: "json",
            async: true,
            url: Ibos.app.url("user/home/isRegister"),
