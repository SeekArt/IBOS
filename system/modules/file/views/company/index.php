    ...
    <div class="page-list">
        ...
        <div class="page-list-mainer">
            ...
            <div class="fc-topbar clearfix">
                <div class="fc-nav clearfix" id="fc_breadcrumb"></div>
...
<script src='<?php echo $this->getAssetUrl(); ?>/js/cabinet_company.js?<?php echo VERHASH; ?>'></script>

<script>
    Ibos.app.s({
        "pid": <?php echo $pid; ?>,
        "cabinetType": "company",
        "isAdministrator": <?php echo $isManager; ?>
    })
</script>
