    ...
    <form id="access_dialog_form" method="post" class="fill">
		<div class="form-horizontal form-narrow">
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="rScope" data-toggle="userSelect" id="rScope" value="<?php echo $rScope; ?>">
				</div>
			</div>
			<div class="control-group">
				<label class="control-label">
				...
				<div class="controls">
					<input type="text" name="wScope" data-toggle="userSelect" id="wScope" value="<?php echo $wScope; ?>">
				</div>
			</div>
		</div>
    </form>
