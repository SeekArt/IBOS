            ...
            <div class="page-list">
                <div class="page-list-header">
                    <div class="row">
                        <div class="span9">
                            ...
                            <?php if ($search): ?>
                                <?php echo $lang['Match conditions']; ?>：<?php echo $count; ?>, <a
                                    href="<?php echo $this->createUrl('dashboard/trash'); ?>"><?php echo $lang['Return list']; ?></a>
                            <?php endif; ?>
                        </div>
                        <div class="span3">
                            <form
                                action="<?php echo $this->createUrl('dashboard/trash', array('param' => 'search')); ?>"
                                class="form-horizontal" method="post">
                                <div class="search">
                                    <input type="text" name="keyword" placeholder="Search" id="trash_search"
                ...
                <div class="page-list-mainer">
                    <table class="table table-striped span12" id="file_trash_table">
                        ...
                        <tr>
                            <th width="20">
                                <label class="checkbox" for="checkbox_0"><span class="icon"></span><span
                        ...
                        <?php foreach ($datas as $data): ?>
                            <tr id="list_tr_<?php echo $data['id']; ?>">
                                <td>
                                    <label class="checkbox" for="checkbox_<?php echo $data['fid']; ?>"><span
                                            class="icon"></span><span class="icon-to-fade"></span>
                                        <input type="checkbox" value="<?php echo $data['fid']; ?>"
                                               id="checkbox_<?php echo $data['fid']; ?>" name="fids[]">
                                    </label>
                                </td>
                                <td>
                                    <div class="ellipsis" style="max-width:200px;"
                                         title="<?php echo $data['location']; ?>">
                                        <?php echo $data['name']; ?>
                                    </div>
                                </td>
                                <td><?php echo $data['realname']; ?></td>
                                <td>
                                    <div class="ellipsis" style="max-width:460px;"
                                         title="<?php echo $data['location']; ?>">
