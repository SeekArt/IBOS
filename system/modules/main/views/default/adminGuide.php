					...
					<div class="as-content-body animated flipInY">
						<div class="middle-area">
							...
							<div class="normal-content">
								<input type="text" class="mb" placeholder="<?php echo $lang['Company fullname']; ?>" id="full_name" value="<?php echo $fullname; ?>" nofocus>
								<div class="clearfix mb xal">
									<input type="text" class="span4 pull-left" placeholder="<?php echo $lang['Company shotname']; ?>" id="in_short" value="<?php echo $shortname; ?>" nofocus>
									<input type="text" class="span6 pull-right URL-input" placeholder="<?php echo $lang['System url']; ?>" id="url" value="<?php echo $pageUrl; ?>" nofocus>
								</div>
								...
								<div class="" style="margin-bottom:10px; height:274px; overflow:hidden;">
									...
									<div class="add-workmate" id="add_workmate">
										<div class="clearfix mb">
											<input type="text" class="pull-left normal-width personal" name="username" placeholder="<?php echo $lang['Account']; ?>" id="username" nofocus>
											<input type="text" class="pull-right normal-width personal" name="password" placeholder="<?php echo $lang['Password']; ?>" id="password" nofocus>
										</div>
										<div class="clearfix mb">
											<input type="text" class="pull-left normal-width personal" name="realname" placeholder="<?php echo $lang['Realname']; ?>" id="realname" nofocus>
											<input type="text" class="pull-right normal-width personal" name="mobile" placeholder="<?php echo $lang['Mobile']; ?>" id="mobile" nofocus>
										</div>
										<div class="clearfix mb">
											<!-- 部门，填完公司资料后，后台利用缓存ajax返回 -->
											<select class="normal-width pull-left personal" id="department" name="department"></select>
											<!-- 岗位，填完公司资料后，后台利用缓存ajax返回 -->
											<select class="normal-width pull-right personal" id="position" name="position"></select>
										</div>
										<input type="text" class="mb personal" placeholder="<?php echo $lang['Email url']; ?>" id="email" name="email" nofocus>
									</div>
								</div>
								<button type="button" class="btn btn-warning btn-add-account" id="continue_add" style="display:none;">
									<i class="o-add-account"></i>
									<span class="fsn"><?php echo $lang['Add continue']; ?></span>
								</button>
								<button type="button" href="javascript:;" class="btn btn-warning btn-add-account" id="add_account">
					...
					<div class="sf-content-body animated flipInY">
						<div class="middle-area">
							...
							<div class="as-area-content">
								...
								<a href="<?php echo Yii::app()->urlManager->createUrl( 'dashboard/default/index', array( 'refer' => '/?r=dashboard/user/index' ) ); ?>" class="perfect-framework fss">
									<i class="o-framework"></i>
									<p><?php echo $lang['Perfect organization']; ?></p>
								</a>
								<a href="<?php echo Yii::app()->urlManager->createUrl( 'dashboard/default/index' ); ?>" class="backstage-set fss">
