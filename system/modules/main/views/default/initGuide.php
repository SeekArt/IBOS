						...
						<div class="top-area">
							...
							<div class="degree-of-complete">
								...
								<div class="progress progress-striped">
									<div class="progress-bar" id="progress_one" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 0%">
									</div>
								</div>
							</div>
						</div>
					...
					<div class="sp-content-body animated flipInY">
						<div class="middle-area">
							...
							<div class="area-content">
								...
								<input type="text" class="mb password" id="raw_password" name="originalpass" placeholder="<?php echo $lang['Original password']; ?>" tabindex="1" nofocus>
								<input type="password" class="mb password" id="new_password" name="newpass" placeholder="<?php echo $lang['New password']; ?>" tabindex="2" nofocus>
								<input type="password" class="password" id="sure_password" name="newpass_confirm" placeholder="<?php echo $lang['Confirm password']; ?>" tabindex="3" nofocus>
							</div>
						</div>
					</div>
						...
						<div class="top-area">
							...
							<div class="degree-of-complete">
								<div class="mbs">
									...
									<span>%，</span>
									<span class="percent-tip" id="tip_step"><?php echo $lang['Upload true picture']; ?></span>
									<span class="badge" id="add_nub">+30%</span>
								</div>
								<div class="progress progress-striped">
									<div class="progress-bar" role="progressbar" id="progress_two" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 0%">
									</div>
								</div>
					...
					<div class="sp-content-body animated flipInY">
						<div class="middle-area">
							...
							<div class="area-content">
								...
								<input type="text" class="mb" id="mobile" name="mobile" placeholder="<?php echo $lang['Mobile']; ?>" nofocus>
								<input type="text" class="mb" id="email" name="email" placeholder="<?php echo $lang['Email']; ?>" nofocus>
								<div class="datepicker" id="date_time" style="position:relative; z-index:99999;">
									<a href="javascript:;" class="datepicker-btn"></a>
									<input type="text" class="datepicker-input" id="birthday" placeholder="<?php echo $lang['Birthday']; ?>" nofocus>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="sf-content-top">
						...
						<div class="top-area">
							...
							<div class="degree-of-complete">
								...
								<div class="progress progress-striped">
									<div class="progress-bar" role="progressbar" id="progress_three" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 0%">
									</div>
								</div>
							</div>
						</div>
