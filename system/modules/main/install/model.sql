...
INSERT INTO `{{setting}}` (`skey`, `svalue`) VALUES ('filetype', 'csv, chm, pdf, zip, rar, tar, gz, bzip2, gif, jpg, jpeg, png, txt, doc, xls, ppt, docx, xlsx, pptx');
...
INSERT INTO `{{setting}}` (`skey`, `svalue`) VALUES ('version','4.2.0 pro');
