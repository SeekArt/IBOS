...
<div class="mc clearfix">
    ...
    <div class="mcr">
        <div class="ct fill">
            <form id="add_form" action="<?php echo $this->createUrl('web/add'); ?>" method="post"
                ...
                <?php if (!empty($errMsg)): ?>
                    <div class="alert alert-danger">
                        ...
                        <?php endforeach; ?>
                        <span>若设置失败, 请查看</span>
                        <a href="http://doc.ibos.com.cn/article/detail/id/330" target="_blank"
                           class="xcbu">[常见问题及解决方法]</a>
                    </div>
                <?php endif; ?>
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="mal"
                                   placeholder="(<?php echo $lang['For example']; ?>：yourname@ibos.com.cn)"
                                   name="web[address]" class="span6"
                                   value="<?php if (isset($web['address'])):echo $web['address'];endif; ?>"/>
                        </div>
                    </div>
                    <div class="control-group" id="mal_reset_row">
                        <label class="control-label"><?php echo $lang['Password']; ?>：</label>
                        <div class="controls">
                            <input type="password" name="web[password]" class="span6"
                                   value="<?php if (isset($web['password'])):echo $web['password'];endif; ?>"/>
                        </div>
                    </div>
                    <?php if ($more): ?>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" name="web[nickname]" class="span6"
                                       value="<?php if (isset($web['nickname'])):echo $web['nickname'];endif; ?>"/>
                        ...
                        <div class="control-group mbm">
                            ...
                            <div class="controls">
                                <input type="text" id="mal_pop_server" name="web[server]" class="span6"
                                       value="<?php if (isset($web['server'])):echo $web['server'];endif; ?>"/>
                        ...
                        <div class="control-group mbm" id="mal_pop_row" style="display:none;">
                            ...
                            <div class="controls">
                                <input type="text" id="mal_pop_port" name="web[port]"
                                       value="<?php if (isset($web['port'])):echo $web['port'];
                                       else: echo 110; endif; ?>" class="span6"/>
                            </div>
                        </div>
                        <?php
                        $enableOpenSsl = extension_loaded('openssl');
                        ?>
                        ...
                        <div class="control-group">
                            <div class="controls">
                                <label class="checkbox">
                                    <input type="checkbox" name="web[ssl]" id="" value="1"
                                           <?php if (isset($web['ssl']) && $web['ssl'] == '1'): ?>checked<?php endif; ?> /><?php echo $lang['Use ssl connect']; ?>
                                </label>
                            </div>
                        </div>
                        <?php endif; ?>
                        <div class="control-group mbm">
                            ...
                            <div class="controls">
                                <input type="text" id="mal_smtp_server" name="web[smtpserver]" class="span6"
                                       value="<?php if (isset($web['smtpserver'])):echo $web['smtpserver'];endif; ?>"/>
                                <a href="javascript:;" class="ilsep" data-click="showRow"
                        ...
                        <div class="control-group mbm" id="mal_smtp_row" style="display:none;">
                            ...
                            <div class="controls">
                                <input type="text" id="mal_smtp_port" name="web[smtpport]" class="span6"
                                       value="<?php if (isset($web['smtpport'])):echo $web['smtpport'];
                                       else: echo 25; endif; ?>"/>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            <div class="controls">
                                <label class="checkbox">
                                    <input type="checkbox" name="web[smtpssl]" id="" value="1"
                                           <?php if (isset($web['smtpssl']) && $web['smtpssl'] == '1'): ?>checked<?php endif; ?> /><?php echo $lang['Use ssl connect']; ?>
                                </label>
                            </div>
                        </div>
                        <?php endif; ?>
