	...
	<form id="add_form" action="<?php echo $this->createUrl( 'web/add' ); ?>" method="post" class="form-horizontal">
		...
		<table class="table table-condensed">
			<tr>
				...
				<td><input type="text" id="mal" name="web[address]" value="<?php echo isset( $web['address'] ) ? $web['address'] : ''; ?>" /></td>
			</tr>
			<tr>
				<th><?php echo $lang['Password']; ?>：</th>
				<td><input type="password" id="pwd" name="web[password]" value="<?php echo isset( $web['password'] ) ? $web['password'] : ''; ?>" /></td>
			</tr>
			<?php if ( $more ): ?>
				<tr>
				...
				<tr id="mal_pop_row" style="display:none;">
					...
					<td>
						...
						<label><input type="checkbox" name="web[ssl]" value="1" /><?php echo $lang['Use ssl connect']; ?></label>
				...
				<tr id="mal_smtp_row" style="display:none;">
					...
					<td>
						...
						<label><input type="checkbox" name="web[smtpssl]" id="" value="1" /><?php echo $lang['Use ssl connect']; ?></label>
					</td>
				</tr>
