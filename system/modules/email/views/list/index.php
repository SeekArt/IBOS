        ...
        <div class="page-list">
            <div class="page-list-header">
                <div class="btn-toolbar pull-left">
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <?php if ($op == "inbox" || $op == "todo") : ?>
                                <li><a href="javascript:;" data-click="selectUnread"><?php echo $lang['Unread']; ?></a>
                                </li>
                    ...
                    <?php if ($op == 'archive'): ?>
                        <div class="btn-group">
                            <select data-change='subop'
                                    data-param="<?php echo $this->createUrl('list/index', array('op' => 'archive', 'archiveid' => $archiveId)); ?>">
                                <option value="in"
                                        <?php if ($subOp == 'in'): ?>selected<?php endif; ?>><?php echo $lang['Inbox']; ?></option>
                                <option value="send"
                                        <?php if ($subOp == 'send'): ?>selected<?php endif; ?>><?php echo $lang['Outbox']; ?></option>
                            </select>
                        </div>
                    <?php endif; ?>
                    <?php if ($op == 'del'): ?>
                        <div class="btn-group">
                            <button type="button" class="btn" data-click="restore"
                                    data-param="{&quot;url&quot;:&quot;<?php echo $this->createUrl('api/mark', array('op' => 'restore')); ?>&quot;}"><?php echo $lang['Restore']; ?></button>
                        </div>
                        <div class="btn-group">
                            <button type="button" class="btn" data-click="erase"
                                    data-param="{&quot;url&quot;:&quot;<?php echo $this->createUrl('api/cpDel'); ?>&quot;}"><?php echo $lang['Completely remove']; ?></button>
                        </div>
                    <?php endif; ?>
                    <?php if ($op == 'send'): ?>
                        <div class="btn-group">
                            <button type="button" class="btn" data-click="del"
                                    data-param="{&quot;url&quot;:&quot;<?php echo $this->createUrl('api/mark', array('op' => 'delFromSend')); ?>&quot;}"><?php echo $lang['Completely remove']; ?></button>
                        </div>
                    <?php endif; ?>
                    <?php if ($op == 'draft'): ?>
                        <div class="btn-group">
                            <button type="button" class="btn" data-click="erase"
                                    data-param="{&quot;url&quot;:&quot;<?php echo $this->createUrl('api/delDraft', array('archiveid' => $this->archiveId)); ?>&quot;}"><?php echo $lang['Delete draft']; ?></button>
                        </div>
                    <?php endif; ?>
                    <?php if ($allowRecall && $op == 'send'): ?>
                        <div class="btn-group">
                            <button type="button" class="btn" data-click="recall"
                                    data-param="{&quot;url&quot;:&quot;<?php echo $this->createUrl('api/recall') ?>&quot;}"><?php echo $lang['Recall']; ?></button>
                        </div>
                    <?php endif; ?>
                    <?php if ($op == 'web'): ?>
                        <div class="btn-group">
                            <a href="javascript:;" class="btn btn-primary"
                               data-toggle="dropdown"><?php echo $lang['Receive mail']; ?></a>
                            <ul class="dropdown-menu">
                                <li><a href="javascript:;"
                                       data-param="{&quot;url&quot;:&quot;<?php echo $this->createUrl('web/receive'); ?>&quot;,&quot;name&quot;:&quot;<?php echo $lang['All emails']; ?>&quot;}"
                                       data-click="receiveMail"><?php echo $lang['All']; ?></a></li>
                                <?php foreach ($this->webMails as $val): ?>
                                    <li><a href="javascript:;"
                                           data-param="{&quot;url&quot;:&quot;<?php echo $this->createUrl('web/receive', array('webid' => $val['webid'])); ?>&quot;,&quot;name&quot;:&quot;<?php echo $val['address']; ?>&quot;}"
                                           data-click="receiveMail"><?php echo $val['address']; ?></a></li>
                                <?php endforeach; ?>
                            </ul>
                            <a target="_blank" href="<?php echo $this->createUrl('web/index'); ?>"
                               class="btn btn-primary btn-icon"><i class="o-setup"></i></a>
                        </div>
                    <?php endif; ?>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <?php if ($op == 'todo'): ?>
                                    <li><a href="javascript:;" data-click="unmark"
                                           data-param="{&quot;url&quot;:&quot;<?php echo $this->createUrl('api/mark', array('op' => 'todo')); ?>&quot;}"><?php echo $lang['Cancel todo']; ?></a>
                                    </li>
                                <?php else: ?>
                                ...
                                <?php if ($op == 'folder'): ?>
                                    <li data-node-type="moveTargetItem" data-id="1">
                                        <a href="javascript:;" data-click="moveToFolder"
                                           data-param="{&quot;fid&quot;:&quot;1&quot;,&quot;url&quot;: &quot;<?php echo $this->createUrl('api/mark', array('op' => 'move')); ?>&quot;}"><?php echo $lang['Move to inbox']; ?></a>
                                    </li>
                                <?php endif; ?>
                ...
                <?php if (!in_array($op, array('send', 'draft'))): ?>
                    <div class="band band-primary">
                        <?php if ($unreadCount > 0): ?>
                            <?php echo Ibos::lang('New unread messages', '', array('{count}' => $unreadCount)) ?>,<a
                                href="javascript:;"
                                data-param="{&quot;url&quot;:&quot;<?php echo $this->createUrl('api/setAllRead'); ?>&quot;}"
                                data-click="markReadAll" class="anchor ilsep"><?php echo $lang['Set all read']; ?></a>
                        <?php else: ?>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <?php foreach ($list as $data): ?>
                        ...
                        <tr id="list_tr_<?php echo $id; ?>">
                            ...
                            <td>
                                <a href="<?php echo $clickUrl; ?>" class="art-list-title">
                                    <?php if ($op != 'send' && $isRead == 0): ?><strong
                ...
                <div class="page-num-select">
                    <div class="btn-group dropup">
                        ...
                        <ul class="dropdown-menu" id="page_num_menu"
                            data-url="<?php echo $this->createUrl('list/index', array('op' => $op)); ?>">
