				...
				<div class="btn-toolbar pull-left">
					...
					<div class="btn-group">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="javascript:;" data-click="unmark" data-param="{&quot;url&quot;:&quot;<?php echo $this->createUrl( 'api/mark', array( 'op' => 'undo' ) ); ?>&quot;}"><?php echo $lang['Cancel todo']; ?></a></li>
				...
				<div class="page-list-footer">
					<div class="page-num-select">
						<div class="btn-group dropup">
							...
							<ul class="dropdown-menu" id="page_num_menu" data-url="<?php echo $this->createUrl( 'list/search', array( 'condition' => $condition ) ); ?>" >
...
<script>
	(function() {
		...
		$pageNumCtrl.on("select", function(evt) {
			window.location.href = Ibos.app.url('email/list/search', { condition: '<?php echo $condition; ?>', pagesize: evt.selected });
		});
	})();
