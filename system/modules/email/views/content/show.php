            ...
            <div class="mal-view">
                ...
                <div class="ctb bglb media bdbs">
                    ...
                    <div class="media-body">
                        <a href="javascript:;" class="pull-right mal-showmore noprint" data-click="toggleSenderDetail" data-param="{&quot;briefId&quot;: &quot;mal_info_brief&quot;,&quot;detailId&quot;: &quot;mal_info_detail&quot;}">
                    ...
                    <div class="ctb bglg bdbs noprint">
                        ...
                        <ul class="attl">
                            <?php foreach ( $attach as $fileInfo ): ?>
                                <li>
                                    <i class="atti"><img src="<?php echo $fileInfo['iconsmall']; ?>" alt="<?php echo $fileInfo['filename']; ?>"></i>
                                    <div class="attc">
                                        <div>
                                            <?php echo $fileInfo['filename']; ?><span class="tcm">(<?php echo $fileInfo['filesize']; ?>)</span>
                                        </div>
                                        <span class="fss">
