...
<table width="100%">
    <tbody>
        ...
        <tr>
            ...
            <td valign="top" style="border-color:#ffffff;background-color:#efefef;">
				<?php echo Convert::formatDate( $body['sendtime'] ); ?>( <?php echo $lang['Week'] . DateTime::getWeekDay( $body['sendtime'] ); ?> )
            </td>
        </tr>
        <tr>
            <td valign="top" style="word-break:break-all;border-color:#ffffff;background-color:#efefef;" colspan="1" rowspan="1">
