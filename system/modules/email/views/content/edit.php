...
<div class="mc clearfix">
    ...
    <div class="mcr">
        <!-- Mainer content -->
        <form action="<?php echo $this->createUrl('content/edit'); ?>" method="post" id="email_form"
            ...
            <div class="ct ctform cti">
                ...
                <div class="well well-full">
                    <div class="mal-form">
                        ...
                        <div class="control-group" data-toggle="buttons-checkbox">
                            <div class="controls btn-group">
                                <a href="javascript:;" id="toggle_other_rec" class="btn btn-small"
                                   data-click="toggleRec"
                                   data-param="{&quot;targetId&quot;: &quot;cc_bcc&quot;,&quot;inputId&quot;: &quot;cc_bcc_value&quot;}"><?php echo $lang['CC']; ?>
                                    / <?php echo $lang['Secret to']; ?></a>
                                <a href="javascript:;" id="toggle_web_rec" class="btn btn-small" data-click="toggleRec"
                                   data-param="{&quot;targetId&quot;: &quot;web_rec&quot;,&quot;inputId&quot;: &quot;web_rec_value&quot;}"><?php echo $lang['External recipient']; ?></a>
                            </div>
                        ...
                        <div id="cc_bcc" style="display:none">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="copytoids" name="emailbody[copytoids]"
                                           value="<?php echo $email['copytoids']; ?>">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="secrettoids" name="emailbody[secrettoids]"
                                           value="<?php echo $email['secrettoids']; ?>">
                            ...
                            <div id="web_rec" style="display:none">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="emailbody[towebmail]" id="to_web_email"
                                               value="<?php echo $email['towebmail']; ?>"
                                ...
                                <div class="control-group">
                                    <div class="controls btn-group">
                                        ...
                                        <a href="<?php echo $this->createUrl('web/list'); ?>" target="_blank"
                        ...
                        <div class="control-group">
                            <div class="control-label control-label-btn btn-group">
                                <a href="#" class="btn btn-block dropdown-toggle" data-toggle="dropdown" id="mal_level"
                                   data-selected="<?php echo $email['important']; ?>">
                                    <span><?php echo $lang['Normal mail']; ?></span>
                                    <i class="caret"></i>
                                </a>
                                <ul class="dropdown-menu xal">
                                    <li data-value="0"><a href="javascript:;"><?php echo $lang['Normal mail']; ?></a>
                                    </li>
                                ...
                                <input type="hidden" name="emailbody[important]" id="mal_level_val"
                                       value="<?php echo $email['important']; ?>">
                            </div>
                            <div class="controls">
                    ...
                    <!-- Row 8 编辑器  -->
                    <div class="bdbs">
                        <script id="editor" name="emailbody[content]"
                                type="text/plain"><?php echo $email['content']; ?></script>
                    </div>
                    <div class="att">
                        <div class="attb">
                            <a href="javascript:;" id="upload_btn"></a>
                            <input type="hidden" name="emailbody[attachmentid]" id="attachmentid"
                                   value="<?php echo $email['attachmentid']; ?>"/>
                        ...
                        <div class="stand">
                            ...
                            <div class="pull-right">
                                <input type="checkbox" name="emailbody[isneedreceipt]" value="1" data-toggle="switch"
                                       <?php if ($email['isneedreceipt']): ?>checked<?php endif; ?>>
                            </div>
                        </div>
                    </div>
                ...
                <div id="submit_bar" class="clearfix">
                    ...
                    <div class="pull-right">
                        ...
                        <button type="submit" name="emailbody[issend]" value="1"
                                class="btn btn-large btn-submit btn-primary"
