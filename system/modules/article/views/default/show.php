										...
										<div class="ad-thumbs">
											<ul class="ad-thumb-list">
												<?php foreach ( $pictureData as $key => $picture ): ?>
													<li>
														<a href="<?php echo File::imageName( $picture['filepath'] ); ?>">
															<img src="<?php echo File::imageName( $picture['filepath'] ); ?>" alt="<?php echo $picture['filename']; ?>" />
															<!-- 此处输出索引和总张数 -->
									...
									<?php foreach ( $attach as $fileInfo ): ?>
										<li>
											...
											<div class="attc">
												...
												<span class="fss">
													<a href="<?php echo $fileInfo['downurl']; ?>" target="_blank" class="anchor">下载</a>&nbsp;&nbsp;
