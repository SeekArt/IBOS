            ...
            <div class="ctb">
                ...
                <div class="ctbw">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="checkbox" name="articlecommentenable" value='1' id="" data-toggle="switch"
                                   <?php if ($data['articlecommentenable']): ?>checked<?php endif; ?>>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            ...
                            <?php else: ?>
                                <input type="checkbox" name="articlevoteenable" value='1' id="" data-toggle="switch"
                                       <?php if ($data['articlevoteenable']): ?>checked<?php endif; ?>>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="checkbox" name="articlethumbenable" value='1' id="thumb_operate"
                                   data-toggle="switch"
                                   <?php if ($data['articlethumbenable']): ?>checked<?php endif; ?>>
                        </div>
                    </div>
                    <div class="control-group thumb-operate"
                         style="<?php if ($data['articlethumbenable']): ?>display:block<?php endif; ?><?php if (!$data['articlethumbenable']): ?>display:none<?php endif; ?>">
                        <label for="" class="control-label"><?php echo $lang['Thumbnail size']; ?></label>
                        <div class="controls">
                            <input type="text" class="span3" name="articlethumbwidth"
                                   value='<?php echo $data['articlethumbwidth']; ?>'> &nbsp; X &nbsp; <input type="text"
                                                                                                             class="span3"
                                                                                                             name="articlethumbheight"
                                                                                                             value='<?php echo $data['articlethumbheight']; ?>'>
                        </div>
                    </div>
                    <div class="control-group">
