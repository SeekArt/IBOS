 ...
 * @method formVerify
 */
ArticleAdd.formVerify = function(){
	//article_form
	var af = "article_form";
 ...
 * @method articleEdit
 */
ArticleAdd.articleEdit = function(){
 ...
 * @method uploadFile
 */
ArticleAdd.uploadFile = function(){
	//上传
 ...
 * @method init
 */
ArticleAdd.otherFunction = function(){
	// tab 事件
