...
class CommentController extends BaseController
{
    ...
    {
        $actions = array(
            'getcommentview' => 'application\modules\article\actions\comment\GetCommentView',
        );
        return $actions;
    }
    ...
    public function actionGetCommentList()
    {
        if (Env::submitCheck('formhash')) {
            ...
            $widget = Ibos::app()->getWidgetFactory()->createWidget($this,
                'application\modules\article\core\ArticleComment', $properties);
    ...
    public function actionAddComment()
    {
        if (Env::submitCheck('formhash')) {
            $widget = Ibos::app()->getWidgetFactory()->createWidget($this,
                'application\modules\article\core\ArticleComment');
