...
<div class="ct">
	...
	<!-- 运行记录 start -->
	<div>
		<form action="<?php echo $this->createUrl( 'split/index', array( 'op' => 'moving', 'mod' => 'email', 'sourcetableid' => $sourceTableId ) ); ?>" method="post" class="form-horizontal">
			<div class="ctb">
				...
				<div class="page-list">
					<div class="page-list-mainer">
						<table class="table table-condensed">
							...
							<tbody>
								<tr>
									<td rowspan="2"><label class="radio"><input type="radio" name="tableid" <?php if ( $sourceTableId == 0 ): ?>disabled<?php endif; ?> value="0" /></label></td>
							...
							<?php foreach ( $tables as $tableId => $value ): ?>
								<tbody>
									<tr>
										<td rowspan="2"><label class="radio"><input type="radio" name="tableid" <?php if ( $sourceTableId == $tableId ): ?>disabled<?php endif; ?> value="<?php echo $tableId; ?>" /></label></td>
					...
					<div class="page-list-footer">
						<div class="span3">
							<div class="input-group">
								...
								<input type="hidden" name="readytomve" value="<?php echo isset( $readyToMove ) ? $readyToMove : 0; ?>" />
							...
							<br/>
							<label title="<?php echo $lang['Pertime desc']; ?>" class="checkbox"><input type="checkbox" name="setcron" value="1" /><?php echo $lang['Save my settings to schedule task']; ?></label>
						</div>
					</div>
				</div>
			</div>
