...
<div class="ct">
	...
	<div>
		<form action="<?php echo $this->createUrl( 'split/index', array( 'op' => 'manage', 'mod' => 'email' ) ); ?>" method="post" class="form-horizontal">
			<!-- 运行记录 start -->
			<div class="ctb">
				<h2 class="st"><?php echo $lang['email']; ?></h2>
				<div class="btn-group control-group" data-toggle="buttons-radio">
					<a href="<?php echo $this->createUrl( 'split/index', array( 'op' => 'manage', 'mod' => 'email' ) ); ?>" class="btn active"><?php echo $lang['Split manage']; ?></a>
					<a href="<?php echo $this->createUrl( 'split/index', array( 'op' => 'move', 'mod' => 'email' ) ); ?>" class="btn"><?php echo $lang['Split move']; ?></a>
				</div>
						...
						<table class="table table-condensed">
							...
							<tbody>
								<tr>
									...
									<td rowspan="2"><input type="text" name="memo[0]" value="<?php echo $tableInfo[0]['memo']; ?>" /></td>
								</tr>
								<tr>
			...
			<div class="ctb">
				...
				<div class="page-list">
					<div class="page-list-mainer">
						<table class="table table-condensed">
							...
							<?php foreach ( $tables as $tableId => $value ): ?>
								<tbody>
									<tr>
										<td rowspan="2"><input type="text" name="displayname[<?php echo $tableId; ?>]" value="<?php echo isset( $tableInfo[$tableId] ) ? $tableInfo[$tableId]['displayname'] : ''; ?>" /></td>
										...
										<td rowspan="2"><input type="text" name="memo[<?php echo $tableId; ?>]" value="<?php echo isset( $tableInfo[$tableId] ) ? $tableInfo[$tableId]['memo'] : ''; ?>" /></td>
										<td rowspan="2"><a href="<?php echo $this->createUrl( 'split/index', array( 'op' => 'droptable', 'tableid' => $tableId, 'mod' => 'email' ) ); ?>" class="btn"><?php echo $lang['Delete']; ?></a></td>
									</tr>
									<tr>
					...
					<div class="page-list-footer">
						&nbsp;<button type="submit" name="archiveSubmit" class="btn btn-primary btn-submit"><?php echo $lang['Update table info']; ?></button>
						<a href="<?php echo $this->createUrl( 'split/index', array( 'op' => 'addtable', 'mod' => 'email' ) ); ?>" class="btn"><?php echo $lang['Add archive']; ?></a>
					</div>
				</div>
			</div>
		</form>
