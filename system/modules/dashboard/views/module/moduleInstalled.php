                            ...
                            <tr>
                                <td>
                                    ...
                                    <?php if ($config['param']['icon']): ?>
                                        <img
                                            src="<?php echo Ibos::app()->assetManager->getAssetsUrl($module['module']) . '/image/icon.png'; ?>">
                                    <?php else: ?>
                                ...
                                <td>
                                    ...
                                    <?php else: ?>
                                        <input type="checkbox"
                                               <?php if ($module['disabled'] == 0 && Module::getIsEnabled($module['module'])): ?>checked<?php endif; ?>
                                               value="<?php echo $module['module']; ?>" data-toggle="switch"
                                               class="visi-hidden">
                                    <?php endif; ?>
                                </td>
                                <td>
                                    <?php if (!empty($module['managerUrl'])) : ?>
                                        <a href="<?php echo $module['managerUrl']; ?>" class="cbtn o-conf"
                                           title="<?php echo $lang['Setting']; ?>"></a>
                                    <?php endif; ?>
                                    <?php if (!$module['iscore']): ?>
                                        <a data-module-act="uninstall" module="<?php echo $module['module']; ?>"
                                           href="javascript:void(0);" class="cbtn o-trash"
                                           title="<?php echo $lang['Uninstall']; ?>"></a>
                                    <?php endif; ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
...
<script>
    ...
    (function () {
        ...
        table.find("input[type=checkbox]").on("change", function () {
            var enabled = this.checked, url = '<?php echo $this->createUrl('module/status'); ?>', status = {
                type: '',
                module: this.value
            };
            if (enabled) {
