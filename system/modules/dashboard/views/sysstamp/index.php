    ...
    <div>
        <form action="<?php echo $this->createUrl('sysstamp/index'); ?>" class="form-horizontal" method="post">
                            ...
                            <?php foreach ($list as $key => $stamp): ?>
                                <li>
                                    <div class="stamp-item-hd">
                                        <div class="row">
                                            <div class="span4">
                                                <input type="text" name="stamps[<?php echo $stamp['id']; ?>][sort]"
                                                       value="<?php echo $stamp['sort']; ?>" class="input-small"/>
                                            </div>
                                            <div class="span8">
                                                <input type="text" name="stamps[<?php echo $stamp['id']; ?>][code]"
                                                       value="<?php echo $stamp['code']; ?>" class="input-small"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="stamp-img">
                                        <div class="stamp-img-uploadbg"></div>
                                        <div class="stamp-img-upload"
                                             id="stamp_upload_<?php echo $stamp['id']; ?>_wrap">
                                            <span id="stamp_upload_<?php echo $stamp['id']; ?>"></span>
                                        </div>
                                        <img
                                            <?php if (!empty($stamp['stamp'])): ?>src="<?php echo $stamp['stamp']; ?>"<?php endif; ?>
                                            alt="<?php echo $stamp['code']; ?>"/>
                                        <input type="hidden" name="stamps[<?php echo $stamp['id']; ?>][stamp]"
                                               value="<?php echo $stamp['stamp']; ?>"/>
                                    </div>
                                    <div class="stamp-icon">
                                        <div class="stamp-icon-uploadbg"></div>
                                        <div class="stamp-icon-upload"
                                             id="stamp_icon_upload_<?php echo $stamp['id']; ?>_wrap">
                                            <span id="stamp_icon_upload_<?php echo $stamp['id']; ?>"></span>
                                        </div>
                                        <img
                                            <?php if (!empty($stamp['icon'])): ?>src="<?php echo $stamp['icon']; ?>"<?php endif; ?>
                                            alt="<?php echo $stamp['code']; ?>"/>
                                        <input type="hidden" name="stamps[<?php echo $stamp['id']; ?>][icon]"
                                               value="<?php echo $stamp['icon']; ?>"/>
                                    </div>
                                    <?php if ($stamp['system'] == 0): ?>
                                        <div class="stamp-item-ft">
                                            <div class="pull-right">
                                                <a href="javascript:void(0);" data-type="old"
                                                   data-id="<?php echo $stamp['id']; ?>" data-act="del"
                                                   class="cbtn o-trash" title="<?php echo $lang['Del']; ?>"></a>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                </li>
            ...
            <div>
                ...
                <button type="submit" name="stampSubmit"
...
<script type="text/template" id="upload_add_tpl">
    <li>
        ...
        <div class="stamp-item-ft">
            <div class="pull-right">
                <a href="javascript:;" data-id="<%=id%>" data-act="del" class="cbtn o-trash"
