        ...
        <div class="ctb">
            ...
            <div>
                <div class="btn-group mb">
                    ...
                    <a href="<?php echo $this->createUrl('position/edit', array('op' => 'member', 'id' => $id)); ?>"
                       class="btn">岗位成员管理</a>
                </div>
                <div class="">
                    <form action="<?php echo $this->createUrl('position/edit'); ?>" method="post" id="position_add_form"
