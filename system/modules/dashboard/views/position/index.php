                    ...
                    <div class="page-list">
                        <div class="page-list-header">
                            <div class="btn-toolbar pull-left">
                                <div class="btn-group">
                                    <button type="button" data-action="addPosition" class="btn btn-primary"
                                            id="add_position"><?php echo $lang['Add position']; ?></button>
                                </div>
                            </div>
                            <div class="btn-group pull-left mlm">
                                <button type="button" data-action="removePositions"
