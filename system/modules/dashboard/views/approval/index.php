								...
								<div class="process-step">
									<div class="process-step-list">
										...
										<div class="step-list mb">
											<?php foreach ( $approval['levels'] as $level => $levelInfo ): ?>
												<div class="step-content">
													...
													<div class="related-person" title="<?php echo $levelInfo['title']; ?>">
										...
										<div class="escape-person mb">
											...
											<div class="related-person" title="<?php echo $approval['free']['title']; ?>">
									...
									<div class="approve-description">
										...
										<p title="<?php echo $approval['desc']; ?>" class="description-content"><?php echo!empty( $approval['desc'] ) ? $approval['desc'] : '暂无信息'; ?></p>
									</div>
								</div>
