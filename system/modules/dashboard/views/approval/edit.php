...
<div class="ct sp-ct">
    ...
    <div>
        <form id="process_setting_form" action="<?php echo $this->createUrl('approval/edit'); ?>" method="post"
            ...
            <div class="pf-select-area" id="pf_select_area">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" class="approval-select" name="level1" id="level_one_auditor"
                               value="<?php echo $approval['level1']; ?>">
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">二级审核人员</label>
                    <div class="controls">
                        <input type="text" class="approval-select" name="level2" id="level_two_auditor"
                               value="<?php echo $approval['level2']; ?>">
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">三级审核人员</label>
                    <div class="controls">
                        <input type="text" class="approval-select" name="level3" id="level_three_auditor"
                               value="<?php echo $approval['level3']; ?>">
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">四级审核人员</label>
                    <div class="controls">
                        <input type="text" class="approval-select" name="level4" id="level_four_auditor"
                               value="<?php echo $approval['level4']; ?>">
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">五级审核人员</label>
                    <div class="controls">
                        <input type="text" class="approval-select" name="level5" id="level_five_auditor"
                               value="<?php echo $approval['level5']; ?>">
                    </div>
                </div>
            </div>
            <div class="control-group">
