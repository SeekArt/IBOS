			...
			<div class="ctb">
				...
				<div>
					<div class="ptc radius" id="calculator">
						...
						<input type="hidden" name="creditsFormula" value="<?php echo $creditsFormula; ?>" id="calculator_input">
						...
						<div class="clearfix">
							<div class="pull-left" data-component="panel">
								<ul id="credit_type" class="ptctl clearfix">
									<?php foreach ( $data as $val ): ?>
										<li><a href="javascript:;" data-id="<?php echo $val['cid']; ?>" data-type="entry" data-value="extcredits<?php echo $val['cid']; ?>"><?php echo $val['name']; ?></a></li>
									<?php endforeach; ?>
								</ul>
							</div>
							<div class="pull-right" data-component="keyboard">
								<table class="ptckl">
									<tr>
										<td colspan="2"><a href="javascript:;" class="ptckl-col2 ptckl-back"  data-type="action" title="后退" data-value="back"></a></td>
										<td><a href="javascript:;" class="ptckl-clear" data-type="action" data-value="clear" title="清空"></a></td>
										<td><a href="javascript:;" class="ptckl-operator" data-type="operator" data-value="divide">÷</a></td>
									</tr>
									<tr>
										...
										<td><a href="javascript:;" class="ptckl-operator" data-type="operator" data-value="multiply">×</a></td>
									</tr>
									<tr>
										...
										<td><a href="javascript:;" class="ptckl-operator" data-type="operator" data-value="minus">-</a></td>
									</tr>
									<tr>
										...
										<td rowspan="2"><a href="javascript:;" class="ptckl-operator ptckl-row2" data-type="operator" data-value="plus">+</a></td>
									</tr>
									<tr>
										<td colspan="2"><a href="javascript:;" class="ptckl-col2" data-type="number" data-value="0">0</a></td>
										<td><a href="javascript:;" class="ptckl-operator" data-type="bracket" data-value="(">()</a></td>
									</tr>
								</table>
							</div>
						</div>
