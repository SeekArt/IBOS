		...
		<div class="ctb">
			...
			<div>
				<div class="btn-group mb">
					...
					<a href="<?php echo $this->createUrl( 'roleadmin/edit', array( 'op' => 'member', 'id' => $id ) ); ?>" class="btn">成员管理</a>
				</div>
				<div class="limit-info-wrap">
					<form action="<?php echo $this->createUrl( 'roleadmin/edit' ); ?>" method="post" id="position_edit_form">
						<div class="page-list-header clearfix">
							<div class="pull-left">
								<span class="xwb">名称</span>
								<input class="role-name mls" type="text" name="rolename" id="role_name" value="<?php echo $role['rolename']; ?>" />
							</div>
														...
														<ul class="org-limit-list clearfix">
															<?php foreach ( $group['node'] as $nIndex => $node ): ?>
																...
																<li <?php if ( $isData ): ?>class="org-limit-privilege-wrap"<?php endif; ?>>
																	<div class="posr <?php if ( $checked ): ?>active<?php endif; ?>">
																		<label class="checkbox">
																			...
																			<span class="mlft"><?php echo $node['name']; ?></span>
																		</label>
																		<?php if ( $isData ): ?>
