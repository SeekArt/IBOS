		...
		<form action="<?php echo $this->createUrl( 'sms/setup' ); ?>" method="post" class="form-horizontal">
			...
			<div class="ctb">
				...
				<div class="ctbw">
					<div class="control-group">
						...
						<div class="controls">
							<input type="checkbox" value="1" name="enabled" id="sms_enable" data-toggle="switch" class="visi-hidden" <?php if ( $setup['smsenabled'] == '1' ): ?>checked<?php endif; ?>>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="ctb">
					...
					<div class="ctbw">
						<div class="control-group">
							...
							<div class="controls">
								<label class="radio">
									<input type="radio" name="interface" value="1" <?php if ( $setup['smsinterface'] == '1' ): ?>checked<?php endif; ?>><?php echo $lang['Interface 1']; ?>
								</label>
							</div>
						</div>
						<?php if ( $setup['smsinterface'] == '1' ): ?>
							<div id="interface1_box">
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="interface1[accesskey]" value="<?php echo $setup['smssetup']['accesskey']; ?>" />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">secretKey</label>
									<div class="controls">
										<input type="text" name="interface1[secretkey]" value="<?php echo $setup['smssetup']['secretkey']; ?>" />
									</div>
								</div>
							</div>
						<?php else: ?>
			...
			<div class="control-group">
				<div class="controls">
					...
					<button type="submit" name="smsSubmit" class="btn btn-primary btn-large btn-submit"><?php echo $lang['Submit']; ?></button>
				</div>
			</div>
		</form>
	</div>
