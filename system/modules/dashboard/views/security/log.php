        ...
        <form action="" class="form-horizontal">
            ...
            <div class="ctb">
                ...
                <div class="btn-group control-group" data-toggle="buttons-radio" id="record">
                    <a href="javascript:;" data-action="tableTab" data-param='{ "type": "admincp" }' class="btn active"><?php echo $lang['Log admincp']; ?></a>
                    <a href="javascript:;" data-action="tableTab" data-param='{ "type": "illegal" }' class="btn"><?php echo $lang['Log password mistake']; ?></a>
                    <a href="javascript:;" data-action="tableTab" data-param='{ "type": "login" }' class="btn"><?php echo $lang['Log login record']; ?></a>
                </div>
                <div class="page-list">
