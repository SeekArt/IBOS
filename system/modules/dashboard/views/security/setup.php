		...
		<form action="<?php echo $this->createUrl( 'security/setup' ); ?>" method="post" class="form-horizontal">
			...
			<div class="ctb">
				...
				<div class="control-group">
					...
					<div class="controls">
						<select name='expiration' class='span2'>
							<option value='0' <?php if ( $account['expiration'] == '0' ): ?>selected<?php endif; ?>><?php echo $lang['Expiration never']; ?></option>
							<option value='1' <?php if ( $account['expiration'] == '1' ): ?>selected<?php endif; ?>><?php echo $lang['Expiration one month']; ?></option>
							<option value='2' <?php if ( $account['expiration'] == '2' ): ?>selected<?php endif; ?>><?php echo $lang['Expiration three month']; ?></option>
							<option value='3' <?php if ( $account['expiration'] == '3' ): ?>selected<?php endif; ?>><?php echo $lang['Expiration six month']; ?></option>
						</select>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls ctbw">
						<div class="b-m">
							...
							<input type="hidden" id="minlength" name="minlength" value="<?php echo $account['minlength']; ?>" />
						</div>
						<div>
							<label class="checkbox">
								<input type="checkbox" name="mixed" value="1" <?php if ( $account['mixed'] == 1 ): ?>checked<?php endif; ?> />
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="checkbox" value="1" data-toggle="switch" name="errorlimit" <?php if ( $account['errorlimit'] == 1 ): ?>checked<?php endif; ?> />
						<div>
							<?php echo $lang['Login error retry 1']; ?>
							<input type="text" name="errorrepeat" class="input-small" style="width: 40px;" value="<?php echo $account['errorrepeat']; ?>" />
							<?php echo $lang['Login error retry 2']; ?>
							<input type="text" name="errortime" class="input-small"  style="width: 40px;" value="<?php echo $account['errortime']; ?>" />
				...
				<div class="control-group">
					...
					<div class="controls">
						<select name='autologin' class='span2'>
							...
							<option value='3' <?php if ( $account['autologin'] == '3' ): ?>selected<?php endif; ?>><?php echo $lang['Autologin three month']; ?></option>
						</select>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="timeout" class="w40 input-small" value="<?php echo $account['timeout']; ?>" />
						分钟内无动作自动退出
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<input type="checkbox" data-toggle="switch" name="allowshare" value="1" <?php if ( $account['allowshare'] == 1 ): ?>checked<?php endif; ?> />
					</div>
				</div>
				<div class="control-group">
					<div class="controls">
