...
<div class="ct">
    ...
    <div>
        <form id="sys_security_form" action="<?php echo $this->createUrl('security/ip'); ?>" method="post"
            ...
            <div class="ctb">
                ...
                <div class="page-list b">
                    <div class="page-list-header">
                        <button type="button" data-act="del"
                                class="btn"><?php echo $lang['Delete select ip']; ?></button>
                    </div>
                            ...
                            <?php if (!empty($list)): ?>
                                <?php foreach ($list as $banned) : ?>
                                    <tr>
                                        <td>
                                            <label class="checkbox">
                                                <input type="checkbox" value="<?php echo $banned['id']; ?>" name="id[]"
                                                       data-check="ip">
                                            </label>
                                        </td>
                                        ...
                                        <td>
                                            <input type="text" name="expiration[<?php echo $banned['id']; ?>]"
                                                   value="<?php echo $banned['expiration']; ?>" class="input-small">
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php endif; ?>
                ...
                <div>
                    ...
                    <button type="button" data-act="clear"
                            class="btn btn-large btn-submit"><?php echo $lang['Clear all']; ?></button>
                    <button type="submit"
                            class="btn btn-primary btn-large btn-submit mls"><?php echo $lang['Submit']; ?></button>
                </div>
            </div>
        </form>
    </div>
