				...
				<div class="co-banding-wrap">
					<?php if( $op === "isBinding" ) : ?>
						...
						<div class="co-binding-login">
							<p>登录酷办公管理</p>
							<div class="span11 ml">
								<input type="text" class="mb" value="<?php echo $mobile; ?>" id="bind_mobile" placeholder="请输入帐号" autocomplete="off" <?php if($readonly) : ?>readonly<?php endif; ?>/>
					...
					<?php else : ?>
						<div class="co-binding-info">
							...
							<div class="co-binding-info-box">
								<button type="button" class="btn btn-primary binding-btn-wrap mls" data-action="bindLoginCo">登录酷办公绑定</button>
								<button type="button" class="btn binding-btn-wrap mls" data-action="bindIbosCo">我还没注册酷办公</button>
							</div>
							<?php if( $isInstall ) : ?>
