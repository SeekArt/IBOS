		...
		<div>
			<div <?php if( !$isInstall ) : ?>class="ctb"<?php endif; ?>>
				...
				<div class="co-banding-wrap text-center">
					...
					<div class="co-list-wrap">
						<ul class="clearfix">
							<?php foreach ( $corpList as $corp ): ?>
								<li>
									<div class="co-list-box <?php if ( $corp['isSuperAdmin'] ) : ?>active-box<?php endif; ?>"
					...
					<div>
						<a class="co-login-back" href="/?r=dashboard/cobinding/logout&isInstall=<?php echo $isInstall; ?>">
    ...
    <div style="width:380px">
        <form class="form-horizontal form-compact" id="ibosco_addcorp_form">
            <div class="control-group">
            	...
            	<div class="controls">
                	<input type="text" id="new_corpname" value="<?php echo $createCorpInfo['corpname']; ?>" placeholder="企业全称"/>
                </div>
            </div>
            <div class="control-group">
            	<label class="control-label xcl">企业简称</label>
            	<div class="controls">
                	<input type="text" id="new_corpshortname" value="<?php echo $createCorpInfo['corpshortname']; ?>" placeholder="企业简称">
                </div>
            </div>
        </form>
    </div>
