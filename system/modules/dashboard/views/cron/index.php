                        ...
                        <table class="table table-striped table-operate">
                            ...
                            <?php foreach ($list as $cron): ?>
                                <tr>
                                    <td>
                                        <label class="checkbox">
                                            <input type="checkbox" name="delete[]"
                                                   <?php if ($cron['type'] == 'system'): ?>disabled<?php endif; ?>
                                                   value="<?php echo $cron['cronid']; ?>">
                                        </label>
                                    </td>
                                    <td>
                                        <div>
                                            <input type="text" value="<?php echo $cron['name']; ?>"
                                                   name="namenew[<?php echo $cron['cronid']; ?>]" class="input-small">
                                        </div>
                                        <div>
                                    ...
                                    <td>
                                        <input type="checkbox" name="availablenew[<?php echo $cron['cronid']; ?>]"
                                               value="1" data-toggle="switch" class="visi-hidden"
                                               <?php if ($cron['available'] == '1'): ?>checked<?php endif; ?>
                                               <?php if ($cron['disabled']): ?>disabled<?php endif; ?>/>
                                    </td>
                                    ...
                                    <td>
                                        <a href="<?php echo $this->createUrl('cron/index', array('op' => 'edit', 'id' => $cron['cronid'])); ?>"
                                           class="btn btn-mini"><?php echo $lang['Edit']; ?></a>
                                        <a href="<?php echo $this->createUrl('cron/index', array('op' => 'run', 'id' => $cron['cronid'])); ?>"
                                           class="btn btn-mini"><?php echo $lang['Perform']; ?></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            <tr>
