<div class="ct">
    ...
    <div>
        ...
        <form method="post" class="form-horizontal form-narrow"
              action="<?php echo $this->createUrl('cron/index', array('op' => 'edit')); ?>">
                    ...
                    <select name="weekdaynew" class="span2">
                        ...
                        <?php for ($i = 0; $i <= 6; $i++): ?>
                            <option value="<?php echo $i; ?>"
                                    <?php if ($cron['weekday'] == $i): ?>selected<?php endif; ?>><?php echo $lang['Cron week day ' . $i] ?></option>
                        <?php endfor; ?>
                    </select>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <select name="daynew" class="span2">
                        ...
                        <?php for ($i = 1; $i <= 31; $i++): ?>
                            <option value="<?php echo $i; ?>"
                                    <?php if ($cron['day'] == $i): ?>selected<?php endif; ?>><?php echo $i . $lang['Cron day'] ?></option>
                        <?php endfor; ?>
                    </select>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <select name="hournew" class="span2">
                        ...
                        <?php for ($i = 0; $i <= 23; $i++): ?>
                            <option value="<?php echo $i; ?>"
                                    <?php if ($cron['hour'] == $i): ?>selected<?php endif; ?>><?php echo $i . $lang['Cron hour'] ?></option>
                        <?php endfor; ?>
                    </select>
