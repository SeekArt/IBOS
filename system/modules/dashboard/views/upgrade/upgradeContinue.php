			...
			<div class="ctb">
				...
				<div class="main-content" id="">
					...
					<div id="continue_info">
						<p class="version-title mbl mtl"><?php echo $lang['Last upgrade']; ?>&nbsp;<span class="xcbu"><?php echo $data['stepName']; ?></span><?php echo $lang['Need to continue']; ?></p>
						<button type="button" class="btn btn-primary btn-upgrade" id="continue_upgrade" data-url="<?php echo $data['url']; ?>"><?php echo $lang['Upgrade continue']; ?></button>
