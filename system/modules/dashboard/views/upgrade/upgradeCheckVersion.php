		...
		<form action="" class="form-horizontal">
			<div class="ctb">
				...
				<div class="main-content mtg">
					...
					<span><?php echo $lang['Upgrade not jump']; ?></span><a class="click-link" href="<?php echo $this->createUrl( 'upgrade/index', array( 'op' => 'showupgrade' ) ); ?>"><?php echo $lang['Upgrade this']; ?></a>
				</div>
			</div>
		</form>
	</div>
