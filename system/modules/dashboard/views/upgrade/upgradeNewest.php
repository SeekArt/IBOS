        ...
        <form action="" class="form-horizontal">
            <div class="ctb">
                ...
                <div class="xac mtg">
                    ...
                    <div class="dib mll">
                        <p class="fsl xcm mbs"><?php echo $lang['Upgrade congratulation']; ?><span
                                class="xcbu"><?php echo $lang['Upgrade newest']; ?></span>!</p>
                        <p class="mb xal xcg"><?php echo $lang['Upgrade fashionable']; ?>~</p>
                        <p class="mb xal"><?php echo $lang['Upgrade you can']; ?>：</p>
                        <button type="button" class="btn pull-left"
                                id="checkAgain"><?php echo $lang['Upgrade check again']; ?></button>
                    </div>
                </div>
            </div>
        </form>
