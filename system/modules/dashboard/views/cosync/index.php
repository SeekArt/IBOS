                    ...
                    <?php if (!$isInstall) : ?>
                        <div class="co-sync-auto clearfix">
                            ...
                            <div class="pull-right">
                                <label class="toggle">
                                    <input type="checkbox" name="autoSync" id="auto_sync"
                                           data-toggle="switch" <?php if ($autoSync == 1): ?> checked <?php endif; ?>>
                                </label>
                            </div>
                        </div>
                    <?php endif; ?>
        ...
        <div id="co_sync_progress">
            ...
            <div class="co-binding-progress">
                ...
                <div class="progress progress-striped span12 pull-left progress-area">
                    <div id="progressbar" class="progress-bar" role="progressbar" aria-valuenow="20" aria-valuemin="0"
    ...
    <div class="clearfix">
        <div class="co-sync-box pull-left">
            ...
            <div class="co-sync-tip <%=ibos['ibosAddAct']%>">
                ...
                <span class="sync-tip-detail pull-right" data-action="bindingDetail"
                      data-param='{"list": "ibosAddList", "count": "<%=ibos[' ibosAddNum']%>"}'>详情</span>
            </div>
            <div class="co-sync-tip <%=ibos['ibosDelAct']%>">
                ...
                <span class="sync-tip-detail pull-right" data-action="bindingDetail"
                      data-param='{"list": "ibosDelList", "count": "<%=ibos[' ibosDelNum']%>"}'>详情</span>
            </div>
        </div>
        <div class="co-sync-box pull-right">
            ...
            <div class="co-sync-tip <%=co['coAddAct']%>">
                ...
                <span class="sync-tip-detail pull-right" data-action="bindingDetail"
                      data-param='{"list": "coAddList", "count": "<%=co[' coAddNum']%>"}'>详情</span>
            </div>
            <div class="co-sync-tip <%=co['coDelAct']%>">
                ...
                <span class="sync-tip-detail pull-right" data-action="bindingDetail"
                      data-param='{"list": "coDelList", "count": "<%=co[' coDelNum']%>"}'>详情</span>
            </div>
        </div>
    </div>
    <div class="co-binding-content">
