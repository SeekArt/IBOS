...
<div class="interface-service-wrap">
    ...
    <div class="service-steps-list" id="apply_step_content">
								...
								<span id="userinfo_item" class="userinfo-wrap xwb mbs">
									<div class="login-info-wrap clearfix">
										<div class="user-info-wrap pull-left" id="login_info_wrap">
											<input type="text" id="username" name="username" placeholder="用户名/邮箱" class="span4 guide-user-name">
											<input type="password" id="password" name="password" placeholder="密码" class="span4 guide-user-passwrod">              
										</div>
										<div class="pull-left mls"> 
											<a href="javascript:;" class="btn btn-primary mls" id="login_submit" data-action="login">登录</a>
											<a href="javascript:;"class="btn btn-primary mls open-app-services" id="open_app_services">开通云服务</a>
										</div>
									</div>
								</span>                             
							</div>
		...
		<?php else: ?>
			...
			<div class="xac">
				<a href="<?php echo $this->createUrl( 'index/index' ) ?>" class="btn btn-large btn-primary">已通过, 我要填写授权</a>
			</div> 
		<?php endif; ?>
    </div>
    <div class="service-steps-title clearfix">
