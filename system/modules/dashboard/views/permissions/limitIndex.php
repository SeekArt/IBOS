				...
				<form method="post" enctype="multipart/form-data" class="form-horizontal">
					<div class="mb">
						...
						<select class="span2 at-moduel-select" id="module_select">
							...
							<option data-module="<?php echo $module['module'];?>" value="<?php echo $this->createUrl('permissions/setup', array('module' => $module['module']));?>" <?php if($module['module'] == Env::getRequest('module')):?>selected<?php endif;?>><?php echo $module['name']?></option>
							<?php endforeach;?>
						</select>
					</div>
					<div>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="javascript:;" data-id="<?php echo $content['roleid'];?>" data-limit="edit" class="cbtn o-edit"></a>
									<a href="javascript:;" data-id="<?php echo $content['roleid'];?>" data-limit="del" class="cbtn o-trash mlm"></a>
								</td>
							</tr>
							<?php endforeach;?>
						</tbody>
...
<script src='<?php echo $assetUrl; ?>/js/limit.js?<?php echo VERHASH; ?>'></script>