				...
				<div class="dsh-limit-body fill">
					...
					<ul class="dsh-limit-list clearfix">
						...
						<li class="dsh-limit-privilege-wrap">
							<label>
								<input type="checkbox" name="nodes[<?php echo $node['id']; ?>]" value="<?php echo $isData ? 'data' : $node['id']; ?>" data-node="funcCheckbox" data-pid="<?php echo $mkey;?>">
								<?php if ( $isData ): ?>
								<div class="dsh-limit-privilege">
									<?php foreach($node['node'] as $data):?>
									<input value="" checked name="data-privilege[<?php echo $node['id']; ?>][<?php echo $data['id']; ?>]" type="text" data-text="<?php echo $data['name'];?>" data-toggle="privilegeLevel" style="display: none;">
									<?php endforeach;?>
								</div>
								<?php endif; ?>
						...
						<li>
							<label>
								<input type="checkbox" name="nodes[<?php echo $node['id'];?>]" value="<?php echo $node['id'];?>" data-node="funcCheckbox" data-pid="<?php echo $mkey;?>">
