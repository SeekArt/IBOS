		...
		<div>
			<form action="<?php echo $this->createUrl( 'im/index' ); ?>" method='post' class="form-horizontal">
					...
					<div class="ctbw">
						<div class="control-group">
							...
							<div class="controls row">
								<div class="span4">
									<input type="checkbox" value='1' name="open" id="QQ_enable" data-toggle="switch" class="visi-hidden" <?php if ( $im['open'] == '1' ): ?>checked<?php endif; ?> />
								</div>
								<div class="span8">
									<a target="_blank" href="http://b.qq.com/eim/home.html"><?php echo $lang['about BQQ']; ?></a><br>
									<a target="_blank" href="http://doc.ibos.com.cn/article/detail/id/66"><?php echo $lang['Click to view helper doc']; ?></a>
								</div>
							</div>
						</div>
						<div id="QQ_setup" class="b-m" <?php if ( $im['open'] == '0' ): ?>style="display: none;"<?php endif; ?>>
							<div class="control-group">
								...
								<div class="controls">
									...
									<?php else: ?>
										...
										<?php else: ?>
											...
											?>
											<span class="db tcm">您通过系统自动获取TOKEN，您的TOKEN有效期一般为30天，现已使用<?php echo $timestr; ?>。</span>
										<?php endif; ?>
									<?php endif; ?>
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls row">
									<div class="span4">
										<input type="checkbox" name="sso" value="1" <?php if ( $im['sso'] == '1' ): ?>checked<?php endif; ?> data-toggle="switch" />
									</div>
								</div>
							</div>
							<div class="control-group">
								...
								<div class="controls">
									<label class="checkbox">
										<input name='push[note]' value='1' <?php if ( $im['push']['note'] == '1' ): ?>checked<?php endif; ?> type="checkbox" />
										<span class="mls"><?php echo $lang['Notice push']; ?></span>
									</label>
									<label class="checkbox" title="因为QQ接口的关系，目前暂不支持消息推送">
										<input name='push[msg]' value='1' <?php if ( isset( $im['push']['msg'] ) && $im['push']['msg'] == '1' ): ?>checked<?php endif; ?> type="checkbox" />
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="checkbox" name="showunread" value="1" <?php if ( $im['showunread'] == '1' ): ?>checked<?php endif; ?> data-toggle="switch" />
								</div>
							</div>
							<div class="control-group">
								<label class="control-label"><?php echo $lang['QQ sync account']; ?></label>
								<div class="controls">
									<input type="checkbox" value="1" name="syncuser" <?php if ( $im['syncuser'] == '1' ): ?>checked<?php endif; ?> data-toggle="switch" class="mlm" />
									...
									<div class="controls">
										<div class="clearfix">
											<div class="pull-left ml">
												<button type="button" data-click="mb" class="btn"><?php echo $lang['Manual binding']; ?></button>
											</div>
										</div>
									</div>
								</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<button class="btn btn-primary btn-large btn-submit" name="imSubmit" type="submit"><?php echo $lang['Submit']; ?></button>
					</div>
				</div>
				<input type='hidden' name='refresh_token' value='<?php echo isset( $im['refresh_token'] ) ? $im['refresh_token'] : ''; ?>' />
				<input type='hidden' name='expires_in' value='<?php echo isset( $im['expires_in'] ) ? $im['expires_in'] : ''; ?>' />
