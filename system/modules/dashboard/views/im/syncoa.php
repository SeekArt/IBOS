...
<form action="<?php echo $this->createUrl( 'im/syncoa' ); ?>" enctype="multipart/form-data" id="import_form" method="post" class="prs pls">
    ...
    <div><button type="submit" class="btn mb">开始导入RTX</button></div>
