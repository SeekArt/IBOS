        ...
        <div>
            <form action="<?php echo $this->createUrl( 'im/index' ); ?>" method='post' class="form-horizontal">
                    ...
                    <div class="ctbw">
                        <div class="control-group">
                            ...
                            <div class="controls row">
                                <div class="span4">
                                    <input type="checkbox" value='1' name="open" id="rtx_enable" data-toggle="switch" class="visi-hidden" <?php if ( $im['open'] == '1' ): ?>checked<?php endif; ?> />
                                </div>
                                <div class="span8">
                                    <a target="_blank" href="http://bqq.tencent.com/rtx/index.shtml"><?php echo $lang['about RTX']; ?></a><br>
                                    <a target="_blank" href="http://doc.ibos.com.cn/article/detail/id/69"><?php echo $lang['Click to view helper doc']; ?></a>
                                </div>
                            </div>
                        </div>
                        <div id="rtx_setup" <?php if ( $im['open'] == '0' ): ?>style="display: none;"<?php endif; ?>>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <label class="checkbox">
                                        <input type="checkbox" name='push[note]' value='1' <?php if ( $im['push']['note'] == '1' ): ?>checked<?php endif; ?> />
                                        <?php echo $lang['Notice push']; ?>
                                    </label>
                                    <label class="checkbox">
                                        <input type="checkbox" name="push[msg]" value='1' <?php if ( $im['push']['msg'] == '1' ): ?>checked<?php endif; ?> />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="checkbox" name="syncuser" value='1' data-toggle="switch" class="visi-hidden" <?php if ( $im['syncuser'] == '1' ): ?>checked<?php endif; ?>>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="row">
                                    ...
                                    <div class="span5">
                                        <a href="javascript:void(0);" data-act='syncrtx' class="btn"><?php echo $lang['Synchronization Immediate']; ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="ctb" id="synctooa" <?php if ( $im['open'] == '0' ): ?>style="display: none;"<?php endif; ?>>
                    ...
                    <div class="ctbw">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="row">
                                    <a href="javascript:void(0);" data-act='syncoa' class="btn"><?php echo $lang['Synchronization Immediate']; ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <button name='imSubmit' class="btn btn-primary btn-large btn-submit" type="submit"><?php echo $lang['Submit']; ?></button>
                    </div>
                </div>
...
<script>
    (function() {
        ...
        $("[data-act='syncoa']").on('click', function() {
            ...
            Ui.openFrame(url,{title:'<?php echo $lang['Synchronize oa']; ?>'});
        });
    })();
</script>