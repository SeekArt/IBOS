				...
				<?php if ( $isBinding ) : ?>
					<div class="box-shadow bind-info-wrap">
						...
						<div class="co-binding-login">
							<p>登录酷办公管理</p>
							<div class="span11 ml">
								<input type="text" class="mb" value="<?php echo $mobile; ?>" id="bind_mobile" placeholder="请输入帐号" autocomplete="off" readonly disabled/>
								<input type="password" class="mb" id="bind_password" placeholder="请输入密码"/>
								<button type="button" class="btn btn-primary span12 mb" data-action="loginCorp">登录</button>
								<div>
									<a href="http://www.ibos.com.cn/forgotpass" target="_blank" class="pull-left">忘记密码?</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="co-banding-wrap">
						<div class="co-binding-info">
							...
							<div class="co-binding-info-box">
								<button type="button" class="btn btn-primary binding-btn-wrap mls" data-action="bindLoginCo">登录酷办公</button>
								<button type="button" class="btn binding-btn-wrap mls" data-action="bindIbosCo">注册酷办公</button>
							</div>
						</div>
					</div>
				<?php endif; ?>
    ...
    <div style="width:300px">
        <form class="form-horizontal" id="ibosco_register_form">
            <div class="user-reg-info" id="user_reg_verify">
	            ...
	            <div class="clearfix mb">
	            	<div class="pull-left span11 ml12">
		            	<div class="input-group">
	                		...
	                		<span class="input-group-addon pl pr" data-action="getMobileVerifyCode" data-loading-text="重新发送（<span id='mobile_counting'>60</span>）">获取验证码</span>
	                	</div>
	                	<div class="xcr">
	            ...
	            <div class="clearfix mb">
	                <div class="pull-left span11 ml12">
	                    <button type="button" class="btn btn-warning span12" id="next_reg_state" data-evtname="nextState">注册</button> 
	                </div>
	            </div>
	            <div class="clearfix mb">
	                <div class="pull-left span11 ml12">
	                    <p class="pull-left">已有帐号？<a href="javascript:;" class="xcbu" data-action="bindLoginCo">立即登录</a></p>
	                </div>
	            </div>
            </div>
            <div class="user-reg-info" id="user_reg_info" style="display:none;">
	            ...
	            <div class="clearfix mb">
	                <div class="pull-left span11 ml12">
	                    <button type="button" class="btn btn-primary span12" id="reg_and_bind" data-evtname="registerCo">完成</button> 
	                </div>
	            </div>
            </div>
        </form>
...
<div id="ibosco_login_dialog" style="display:none;">
    <div style="width:300px">
        <form class="form-horizontal" id="ibosco_login_form">
            ...
            <div class="clearfix mb">
                <div class="pull-left span11 ml12">
                    <button type="button" class="btn btn-primary span12" id="login_and_bind" data-evtname="loginCo">登录</button> 
                </div>
            </div>
            <div class="clearfix mb">
                <div class="pull-left span11 ml12">
                    <a href="javascript:;" onclick="javascript:window.open('http://www.kubangong.com/forgotpass');" class="pull-left">忘记密码</a>
