		...
		<div style="padding: 20px; width: 400px;">
			<form class="form-horizontal" method="post" action="<?php echo IBOS::app()->createUrl( 'dashboard/organizationApi/syncuser' ); ?>">
				<div class="control-group">
					...
					<div class="controls">
						是否要<?php if($flag == '1'):echo '增加';elseif($flag=='2'):echo '启用';else: echo '禁用';endif; ?>用户【<?php echo implode( ',', $usernames ); ?>】到企业QQ？ <button type="submit" class="btn">是</button> / <button onclick="javascript:parent.Ui.closeDialog();" type="button" class="btn">否</button>
					</div>
				</div>
