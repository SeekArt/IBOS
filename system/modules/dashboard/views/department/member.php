        ...
        <div class="ctb">
            ...
            <div class="">
                <div class="btn-group mb">
                    <a href="<?php echo $this->createUrl( 'department/edit', array( 'op' => 'get', 'id' => $id ) ); ?>" class="btn">部门设置</a>
                ...
                <div class="limit-info-wrap">
                    ...
                    <div>
                        <form action="<?php echo $this->createUrl( 'department/edit', array( 'op' => 'member' ) ); ?>" method="post" class="role-member-form">
