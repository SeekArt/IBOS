            ...
            <div>
                ...
                <div class="limit-info-wrap">
                    <div class="page-list-header clearfix">
                        <div class="pull-left">
                            <a href="javascript:;" class="btn btn-primary" id="org_member_add">添加用户</a>
                        </div>
                    ...
                    <div>
                        <form action="<?php echo $this->createUrl( 'role/edit', array( 'op' => 'member' ) ); ?>" method="post" class="role-member-form">
