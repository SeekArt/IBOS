            ...
            <div class="ctb">
                ...
                <div class="page-list">
                    <div class="page-list-mainer">
                        <form method="post" action="<?php echo $this->createUrl('notify/setup'); ?>"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="checkbox" data-toggle="switch"
                                                   ...
                                                   <?php if ($node['sendemail']): ?>checked<?php endif; ?> />
                                        </td>
                                        <td>
                                            <input type="checkbox" data-toggle="switch"
...
<script>
    $("#sms_manage_table").on("change", "[data-toggle='switch']", function(){
