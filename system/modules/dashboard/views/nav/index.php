...
<div class="ct">
    ...
    <div>
        <form id="sys_nav_form" action="<?php echo $this->createUrl('nav/index'); ?>" method="post"
                                ...
                                <li data-id="<?php echo $key; ?>">
                                    <div class="nav-item main-nav-item">
                                        <div class="mst-board nav-w36">
                                            ...
                                            <div class="span6">
                                                <input type="text" class="input-small" data-type="name"
                                                       name='navs[<?php echo $key; ?>][name]'
                                                       value="<?php echo $nav['name']; ?>"/>
                                            </div>
                                            <div class="span3 mls add-child-btn">
                                                <a href="javascript:void(0);"
                                                   data-target="#sys_child_<?php echo $key; ?>_body" data-act="add_sec"
                                                   class="cbtn o-plus"></a>
                                                <?php if ($nav['system'] == '0'): ?>
                                                    <a href="javascript:void(0);" data-target='<?php echo $key; ?>'
                                                       data-act="remove_main" class="cbtn o-trash mls"></a>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="nav-w35 system-url">
                                            ...
                                            <?php else: ?>
                                                <div
                                                    class="nav-url <?php if ($nav['type'] == 1): ?>hidden<?php endif; ?>">
                                                    <input type="text" data-type='url'
                                                           name="navs[<?php echo $key; ?>][url]"
                                                           class="input-small span9 <?php if ($nav['type'] == 0): ?>mark<?php endif; ?>"
                                                           value="<?php if ($nav['type'] == 0): ?><?php echo $nav['url']; ?><?php endif; ?>">
                                                </div>
                                                <div
                                                    class="single-page <?php if ($nav['type'] == 0): ?>hidden<?php endif; ?>">
                                                    <a class="dib"
                                                       href="<?php echo Ibos::app()->urlManager->createUrl("main/page/edit", array('pageid' => $nav['pageid'])); ?>"
                                                       target="_blank"
                                                       data-pageid="<?php echo $nav['pageid']; ?>">修改内容</a>
                                                    <a class="dib mls"
                                                       href="<?php echo Ibos::app()->urlManager->createUrl('main/page/index', array('pageid' => $nav['pageid'], 'name' => $nav['name'])); ?>"
                                                       target="_blank">预览</a>
                                                    <input type="hidden" data-type="pageid"
                                                           value="<?php echo $nav['pageid']; ?>">
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                        <div class="nav-w6 isuse">
                                            <label class="checkbox">
                                                <input type="checkbox" data-action="isUse"
                                                       name="navs[<?php echo $key; ?>][disabled]" value="0"
                                                       <?php if ($nav['disabled'] == '0'): ?>checked<?php endif; ?> />
                                            </label>
                                        </div>
                                        <div class="nav-w6">
                                            <label class="checkbox">
                                                <input type="checkbox" name="navs[<?php echo $key; ?>][targetnew]"
                                                       value="1"
                                                       <?php if ($nav['targetnew'] == '1'): ?>checked<?php endif; ?> />
                                            </label>
                                        </div>
                                        <input type="hidden" data-type="module" name="navs[<?php echo $key; ?>][module]"
                                               value="<?php echo $nav['module']; ?>"/>
                                        <input type="hidden" data-type="isSystem"
                                               name="navs[<?php echo $key; ?>][isSystem]"
                                               value="<?php echo $nav['system']; ?>">
                                    </div>
                                    <div class="add-nav-item">
                                        <ul class="nav-child-list" data-id='<?php echo $key; ?>'
                                            id="sys_child_<?php echo $key; ?>_body">
                                            <?php $subCount = count($nav['child']); ?>
                                            <?php $subIndex = 0; ?>
                                            <?php foreach ($nav['child'] as $subKey => $subVal): ?>
                                                <?php $subIndex++; ?>
                                                <li data-id='<?php echo $subVal['id']; ?>'
                                                    ...
                                                    <div class="nav-item child-nav-item">
                                                        <div class="mst-board nav-w36">
                                                            ...
                                                            <div class="span6">
                                                                <input type="text"
                                                                       name="navs[<?php echo $subVal['id']; ?>][name]"
                                                                       data-type='name' class="input-small"
                                                                       value="<?php echo $subVal['name']; ?>"/>
                                                            </div>
                                                            <?php if ($subVal['system'] == '0'): ?>
                                                                <div class="span3 mls add-child-btn">
                                                                    <a data-target='<?php echo $subVal['id']; ?>'
                                                                       data-act="remove_sec" href="javascript:void(0);"
                                                        ...
                                                        <div class="nav-w35 system-url">
                                                            <?php if ($subVal['system'] == '1'): ?>
                                                                ...
                                                                <input type="hidden" data-type='url'
                                                                       value="<?php echo $subVal['url']; ?>">
                                                            <?php else: ?>
                                                                <div
                                                                    class="nav-url <?php if ($subVal['type'] == 1): ?>hidden<?php endif; ?>">
                                                                    <input type="text" data-type='url'
                                                                           class="input-small span9 <?php if ($subVal['type'] == 0): ?>mark<?php endif; ?>"
                                                                           value="<?php if ($subVal['type'] == 0): ?><?php echo $subVal['url']; ?><?php endif; ?>">
                                                                </div>
                                                                <div
                                                                    class="single-page <?php if ($subVal['type'] == 0): ?>hidden<?php endif; ?>">
                                                                    <a class="dib"
                                                                       href="<?php echo Ibos::app()->urlManager->createUrl("main/page/edit", array('pageid' => $subVal['pageid'])); ?>"
                                                                       target="_blank"
                                                                       data-pageid="<?php echo $subVal['pageid']; ?>">修改内容</a>
                                                                    <a class="dib mls"
                                                                       href="<?php echo Ibos::app()->urlManager->createUrl('main/page/index', array('pageid' => $subVal['pageid'], 'name' => $subVal['name'])); ?>"
                                                                       target="_blank">预览</a>
                                                                    <input type="hidden" data-type="pageid"
                                                                           value="<?php echo $subVal['pageid']; ?>">
                                                                </div>
                                                            <?php endif; ?>
                                                        </div>
                                                        <div class="nav-w6 isuse">
                                                            <label class="checkbox">
                                                                <input type="checkbox"
                                                                       name="navs[<?php echo $subVal['id']; ?>][disabled]"
                                                                       value="0"
                                                                       <?php if ($subVal['disabled'] == '0'): ?>checked<?php endif; ?> />
                                                            </label>
                                                        </div>
                                                        <div class="nav-w6">
                                                            <label class="checkbox">
                                                                <input type="checkbox"
                                                                       name="navs[<?php echo $subVal['id']; ?>][targetnew]"
                                                                       value="1"
                                                                       <?php if ($subVal['targetnew'] == '1'): ?>checked<?php endif; ?> />
                                                            </label>
                                                        </div>
                                                        <input type="hidden" data-type="module"
                                                               name="navs[<?php echo $subVal['id']; ?>][module]"
                                                               value="<?php echo $subVal['module']; ?>"/>
                                                        <input type="hidden" data-type="isSystem"
                                                               name="navs[<?php echo $subVal['id']; ?>][isSystem]"
                                                               value="<?php echo $nav['system']; ?>">
                                                    </div>
                                                </li>
                                            <?php endforeach; ?>
            ...
            <div>
                <button id="nav_submit" type="submit" name="navSubmit"
...
<script type="text/ibos-template" id="new_main_nav">
    <div class="nav-item main-nav-item">
        <div class="mst-board nav-w36">
            ...
            <div class="span3 mls add-child-btn">
                <a href="javascript:void(0);" data-target="#sys_child_<%=id%>_body" data-act="add_sec"
                   class="cbtn o-plus"></a>
