...
<div class="mainer" id="mainer">
    <div class="aside" id="aside">
        <div class="main-nav">
            <ul id="main_nav">
                ...
                <?php foreach ($cateConfig as $cate => $config): ?>
                    ...
                    ?>>
                        <a href="<?php echo $config['url']; ?>" target="main"
                           data-href="#db_<?php echo $config['id']; ?>_list" id="db_<?php echo $config['id']; ?>"
                           class="db-<?php echo $config['id']; ?>"><?php echo $lang[$config['lang']]; ?></a>
                    </li>
                <?php endforeach; ?>
            </ul>
        </div>
        <div class="sub-nav" id="sub_nav" style="overflow: auto">
            <?php $i = $j = 1; ?>
            <?php foreach ($routes as $cate => $routeA): ?>
                <ul id="db_<?php echo $cateConfig[$cate]['id']; ?>_list"
                    <?php if ($j !== 1): ?>style="display:none;"<?php endif; ?>>
                    <?php foreach ($routeA as $route => $config): ?>
                        <?php if ($config['config']['isShow']): ?>
