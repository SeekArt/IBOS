<div class="ct">
    ...
    <div>
        <form action="<?php echo $this->createUrl('database/backup'); ?>" method="post" class="form-horizontal">
            ...
            <div class="ctb">
                ...
                <div>
                            ...
                            <div>
                                <ul class="database-backup-list clearfix">
                                    <?php foreach ($tables as $table): ?>
                                        <li>
                                            <label class="checkbox">
                                                <input type="checkbox" name="customtables[]"
                                                       value="<?php echo $table['Name']; ?>"><?php echo $table['Name']; ?>
                                            </label>
                                        </li>
                                    <?php endforeach; ?>
                                </ul>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="checkbox" name="custom_enabled" value="1" id="more_option" data-toggle="switch"
                                   class="visi-hidden">
                        </div>
                    </div>
            ...
            <div class="control-group">
                <div class="controls">
                    <button type="submit" value="1" name="dbSubmit"
