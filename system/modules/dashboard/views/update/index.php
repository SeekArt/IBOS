                        ...
                        <div class="control-group">
                            <div class="controls" id="update_type">
                                <label class="checkbox">
                                    <input type="checkbox" value="data" checked
                                           name="updatetype[]"/><?php echo $lang['Data cache']; ?>
                                </label>
                                <label class="checkbox">
                                    <input type="checkbox" value="static"
                                           name="updatetype[]"/><?php echo $lang['Static cache']; ?>
                                </label>
                                <label class="checkbox">
                                    <input type="checkbox" value="module"
                                           name="updatetype[]"><?php echo $lang['Module setting']; ?>
                                </label>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="controls">
                                ...
                                <button type="button" data-action="submitForm"
                                        class="btn btn-primary btn-large btn-submit"><?php echo $lang['Sure']; ?></button>
                            </div>
                        </div>
                    </div>
                </form>
