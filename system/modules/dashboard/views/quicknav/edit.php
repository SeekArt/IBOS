...
<div class="ct">
    ...
    <div>
        <form action="<?php echo $this->createUrl('quicknav/edit'); ?>" method="post" id="quick_nav_form"
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="url"
                                   value="<?php echo StringUtil::ihtmlSpecialChars($menu['url']); ?>" id="qn_url">
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="pull-left">
                                ...
                                <div id="qn_img_preview" class="quicknav-img-preview">
                                    <img src="<?php echo $menu['icon']; ?>" title="<?php echo $menu['icon']; ?>"
                                         alt="<?php echo $menu['icon']; ?>">
                                </div>
                                <input type="hidden" id="qn_img_value" name="quicknavimg"
                                       value="<?php echo $menu['icon']; ?>">
                            </div>
                            <div class="pull-right">
                                <span id="qn_upload"></span>
                                <button type="button" id="reset_qn_upload"
                                        class="btn vat"><?php echo $lang['Reset']; ?></button>
                            </div>
                        </div>
                        <!-- esle 默认图标 -->
                        <!--
