        ...
        <form action="<?php echo $this->createUrl('dashboard/update'); ?>" method="post" class="form-horizontal">
            ...
            <div class="ctb">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="checkbox" name="calendaraddschedule" data-toggle="switch" value="1"
                               <?php if ($setting['calendaraddschedule'] == 1): ?>checked<?php endif; ?> />
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label"><?php echo $lang['Allow edit schedule']; ?></label>
                    <div class="controls">
                        <input type="checkbox" name="calendareditschedule" data-toggle="switch" value="1"
                               <?php if ($setting['calendareditschedule'] == 1): ?>checked<?php endif; ?> />
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls ctbw">
                        <div class="b-m">
                            ...
                            <input type="hidden" id="workingtime" name="calendarworkingtime"
                                   value="<?php echo $setting['calendarworkingtime'] ?>"/>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="ctb">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="checkbox" name="calendaredittask" data-toggle="switch" value="1"
                               <?php if ($setting['calendaredittask'] == 1): ?>checked<?php endif; ?> />
                    </div>
                </div>
            </div>
            <!-- 提交按钮 -->
