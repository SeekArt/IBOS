		...
		<div class="control-group">
			...
			<div class="controls">
				<label class="checkbox checkbox-inline">
					<input type="checkbox" name="calviewhiddenday" value="1" <?php if(  in_array( 1, $hiddenDays )): ?>checked<?php endif; ?>>
					一
				</label>
				<label class="checkbox checkbox-inline">
					<input type="checkbox" name="calviewhiddenday" value="2" <?php if(  in_array( 2, $hiddenDays )): ?>checked<?php endif; ?>>
					二
				</label>
				<label class="checkbox checkbox-inline">
					<input type="checkbox" name="calviewhiddenday" value="3" <?php if(  in_array( 3, $hiddenDays )): ?>checked<?php endif; ?>>
					三
				</label>
				<label class="checkbox checkbox-inline">
					<input type="checkbox" name="calviewhiddenday" value="4" <?php if(  in_array( 4, $hiddenDays )): ?>checked<?php endif; ?>>
					四
				</label>
				<label class="checkbox checkbox-inline">
					<input type="checkbox" name="calviewhiddenday" value="5" <?php if(  in_array( 5, $hiddenDays )): ?>checked<?php endif; ?>>
					五
				</label>
				<label class="checkbox checkbox-inline">
					<input type="checkbox" name="calviewhiddenday" value="6" <?php if(  in_array( 6, $hiddenDays )): ?>checked<?php endif; ?>>
					六
				</label>
				<label class="checkbox checkbox-inline">
					<input type="checkbox" name="calviewhiddenday" value="0" <?php if(  in_array( 0, $hiddenDays )): ?>checked<?php endif; ?>>
					日
				</label>
			</div>
		</div>
