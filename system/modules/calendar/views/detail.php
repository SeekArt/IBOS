...
<div id="d_cal_detail" class="form-horizontal form-compact" style="width:400px;">
	...
	<div class="control-group">
		...
		<div class="controls">
			<!-- @Todo: 样式待完善 -->
			<a href="javascript:;" class="color-picker" id="cal_color"><span style="background-color: #99C8E8;"></span></a>
	...
	<div id="cal_time_interval">
		<div class="control-group">
			...
			<div class="controls">
				<div class="input-operates date form_datetime" id="date_time_start" data-date-enddate="2013-07-19 16:00">
		...
		<div class="control-group">
			...
			<div class="controls">
				<div class="input-operates date form_datetime" id="date_time_end" data-date-startdate="2013-07-19 15:00">
