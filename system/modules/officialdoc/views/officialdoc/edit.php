...
<div class="mc clearfix">
    ...
    <!-- Mainer right -->
    <div class="mcr">
        <form id="officialdoc_form"
              action="<?php echo $this->createUrl('officialdoc/edit', array('op' => 'update')); ?>" method="post"
            ...
            <div class="ct ctform">
                ...
                <div class="row">
                    <div class="span8">
                        <div class="control-group">
                            ...
                            <input type="text" name="publishScope" value="<?php echo $data['publishScope']; ?>"
                                   id="publishScope">
                        ...
                        <div class="control-group">
                            <div>
                                <div class="btn-group btn-group-justified" data-toggle="buttons-radio"
                                     id="article_status">
                                    <label
                                        class="btn <?php if ($aitVerify == 0 && $data['status'] != 3): ?>active<?php endif; ?>"
                                    ...
                                    <label
                                        class="btn <?php if ($aitVerify == 1 && $data['status'] != 3): ?>active<?php endif; ?>"
                                    ...
                                    <label class="btn <?php if ($data['status'] == 3): ?>active<?php endif; ?>">
                                        <input type="radio" name="status" value="3"
                                               <?php if ($data['status'] == 3): ?>checked<?php endif; ?>>
                            ...
                            <div id="type_article" class="tab-pane active">
                                <div class="bdbs">
                                    <script id="editor" name="content"
                                            type="text/plain"><?php echo $data['content']; ?></script>
                                </div>
                                <div class="att">
                                    <div class="attb">
                                        ...
                                        <input type="hidden" name="attachmentid" id="attachmentid"
                                               value="<?php echo $data['attachmentid']; ?>">
                                            ...
                                            <?php foreach ($attach as $value): ?>
                                                <div class="attl-item" data-node-type="attachItem">
                                                    <a href="javascript:;" title="删除附件" class="cbtn o-trash"
                                                       data-node-type="attachRemoveBtn"
                                                       data-id="<?php echo $value['aid']; ?>"></a>
                                                    <i class="atti"><img width="32" height="32"
													...
													<span class="fss mlm">
														<a href="<?php echo $value['downurl']; ?>" target="_blank"
                                                           class="anchor">下载</a>&nbsp;&nbsp;
                ...
                <div id="submit_bar" class="clearfix">
                    <button type="button" onclick="history.go(-1);"
                            class="btn btn-large btn-submit pull-left"><?php echo Ibos::lang('Return'); ?></button>
                    <div class="pull-right">
                        <button type="button" id="prewiew_submit" data-action="preview"
                        ...
                        <button type="submit" class="btn btn-large btn-submit btn-primary"
                                id="edit_submit"><?php echo Ibos::lang('Submit'); ?></button>
                    </div>
                </div>
            </div>
