		...
		<div class="bglb rdb">
			<div class="wb-contacts-col" data-node-type="relationBox">
				<div class="wb-col-tit">
					<a href="javascript:;" data-action="nextRelation" data-offset="4" data-param='{"type": "colleague"}'>
			...
			<?php if ( !$isMe ): ?>
				<?php if ( $bothfollow['count'] > 0 ): ?>
					<div class="wb-contacts-col" data-node-type="relationBox">
						<div class="wb-col-tit">
							<a href="javascript:;" data-action="nextRelation" data-offset="4" data-param='{"type": "bothfollow"}'>
								<i class="glyphicon-chevron-right"></i>
							</a>
				...
				<?php if ( $secondfollow['count'] > 0 ): ?>
					<div class="wb-contacts-col" data-node-type="relationBox">
						<div class="wb-col-tit">
							<a href="javascript:;" data-action="nextRelation" data-offset="4" data-param='{"type": "secondfollow"}'> 
								<i class="glyphicon-chevron-right"></i>
							</a>
