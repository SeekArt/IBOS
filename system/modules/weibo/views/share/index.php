	...
	<div class="wb-rep mb">
		...
		<?php else: ?>
			<div class="wb-at-someone">
				<a href="<?php echo $oldInfo['source_user_info']['space_url'] ?>" class="wb-source"><?php echo $oldInfo['source_user_info']['realname'] ?>:</a>
			</div>
			<!--转载的内容 S-->
	...
	<div data-node-type="feedForwardComment">
		<form action="javascript:;">
			<div class="wb-pub-box wb-forword-pub">
				<textarea name="body" data-node-type="textarea" class="wb-pub-text" rows="4" placeholder="我也说一句..."><?php echo $shareInfo['initHTML']; ?></textarea>
			</div>
			<!--发布按钮和功能按钮-->
			<div class="clearfix">
				<button type="button" class="btn btn-primary btn-small pull-right" data-action="feedForward" data-node-type="feedForwardBtn">转发</button>
				<div class="pull-left">
