...
<form action="<?php echo $this->createUrl( 'dashboard/setup' ); ?>" class="form-horizontal" method="post">
	<div class="ct">
		<div class="clearfix">
			...
			<div class="ctb">
				...
				<div class="ctbw">
					...
					<div class="control-group">
						...
						<div class="controls">
							<div class="input-group">
								<input type="text" name="wbpostfrequency" value="<?php echo $config['wbpostfrequency']; ?>">
					...
					<div class="control-group">
						...
						<div class="controls">
							<label class="checkbox checkbox-inline">
								<input type="checkbox" value="1" <?php if ( $config['wbposttype']['image'] == 1 ): ?>checked<?php endif; ?> name="wbposttype[image]" />
								<?php echo $lang['Image']; ?>
							</label>
							<!--<label class="checkbox checkbox-inline">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="checkbox" name="wbwatermark" value="1" data-toggle="switch" <?php if ( $config['wbwatermark'] == 1 ): ?>checked<?php endif; ?> />
						</div>
					</div>
					<!--<div class="control-group">
							...
							<div>
								<?php if ( !empty( $movementModule ) ): ?>
									<?php foreach ( $movementModule as $key => $module ): ?>
										...
										<label class="checkbox checkbox-inline">
											<input value="1" type="checkbox" <?php if ( isset( $config['wbmovement'][$module['module']] ) && $config['wbmovement'][$module['module']] == 1 ): ?>checked<?php endif; ?> name="wbmovements[<?php echo $module['module']; ?>]">
