        ...
        <div class="ctb">
            <div class="form-horizontal" >
                ...
                <div class="btn-group control-group" data-toggle="buttons-radio" id="record">
                    <a href="<?php echo $this->createUrl( 'dashboard/comment', array( 'op' => 'list' ) ); ?>" class="btn <?php if ( $op == 'list' ): ?>active<?php endif; ?>"><?php echo $lang['List']; ?></a>
                    <a href="<?php echo $this->createUrl( 'dashboard/comment', array( 'op' => 'recycle' ) ); ?>" class="btn <?php if ( $op == 'recycle' ): ?>active<?php endif; ?>"><?php echo $lang['Recycle bin']; ?></a>
                </div>
            </div>
            <div>
                <div class="page-list">
                    <div class="page-list-header">
                        <div class="btn-toolbar pull-left">
                            <button class="btn" type="button" data-param='{"op":"<?php echo $op == 'list' ? 'delComment' : 'deleteComment'; ?>"}' data-action="removeCms"><?php echo $op == 'list' ? $lang['Del comment'] : $lang['Delete clear']; ?></button>
                        </div>
                        <div class="search span3 pull-right">
                            <input type="text" placeholder="<?php echo $lang['Comment search tip']; ?>" name="keyword" id="mn_search" nofocus="">
                    ...
                    <?php if ( !empty( $list ) ): ?>
                        <div class="page-list-mainer">
                            <table class="table table-striped">
                                <thead>
                                    <tr>
                                        <th width="20"><label class="checkbox"><input type="checkbox" data-name="comment"></label></th>
                                        <th width="30">ID</th>
                                ...
                                <tbody>
                                    <?php foreach ( $list as $cm ): ?>
                                        <tr data-row="<?php echo $cm['cid']; ?>">
                                            <td><label class="checkbox"><input type="checkbox" name="comment" value="<?php echo $cm['cid']; ?>"></label></td>
                                            ...
                                            <td>
                                                <?php if ( $op == 'list' ): ?>
                                                    <a href="javascript:;" class="cbtn o-trash" data-action="removeCm" data-param='{"op":"delComment", "id": <?php echo $cm['cid']; ?>}'></a>
                                                <?php else: ?>
                                                    <a href="javascript:;" class="cbtn o-cancel" data-action="recoverCm" data-param='{"op":"commentRecover", "id": <?php echo $cm['cid']; ?>}'></a>
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
