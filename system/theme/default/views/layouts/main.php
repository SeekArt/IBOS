                            ...
                            <?php if (!empty($nav['child'])): ?>
                                <ul class="subnv" id="sub_nav_<?php echo $index; ?>" data-pid="<?php echo $index; ?>">
                                    <?php foreach ($nav['child'] as $subNav): ?>
                                        ...
                                        <?php if ($hasPurv): ?>
                                            <li>
                                                <a target="<?php echo $subNav['targetnew'] ? '_blank' : '_self';
            ...
            <div class="uil-card" id="user_login_card" style="display:none;">
                ...
                <div class="uil-card-body">
                    ...
                    <div class="btn-group btn-group-justified">
                        ...
                        <?php if (Ibos::app()->user->isadministrator || Ibos::app()->user->roleType): ?><a class="btn"
                               target="_blank"
                               href="<?php echo Ibos::app()->urlManager->createUrl('dashboard/default/index'); ?>" >
                                <i class="om-key"></i><?php echo Ibos::lang('Control', 'default');
