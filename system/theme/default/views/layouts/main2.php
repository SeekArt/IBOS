                                ...
                                <?php foreach ($navs as $index => $nav): ?>
                                    ...
                                    <li data-target="#sub_nav_<?php echo $index; ?>" data-id="<?php echo $index; ?>">
                                        <a href="<?php echo $nav['url']; ?>"
                                           target="<?php echo $nav['targetnew'] ? '_blank'
                                    : '_self'; ?>"><?php echo $nav['name']; ?></a>
                                <?php if (1
                                    == 2): ?><i class="o-new-nav-tip"></i> <?php endif; ?>
                                    </li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
...
<?php echo StringUtil::cutStr(Ibos::app()->user->realname,
    6); ?>
                        ...
                        <div id="message_container" class="reminder" style="display: none;">
                            ...
                            <ul class="reminder-list">
                                ...
                                <li rel="user"><span></span>，<a
                                        href="<?php echo Ibos::app()->urlManager->createUrl('message/notify/detail&module=user'); ?>"
                                        class="anchor">查看消息</a></li>
                                <li rel="diary"><span></span>，<a
                                        href="<?php echo Ibos::app()->urlManager->createUrl('message/notify/detail&module=diary'); ?>"
                                        class="anchor">查看详情</a></li>
                                <li rel="report"><span></span>，<a
                                        href="<?php echo Ibos::app()->urlManager->createUrl('message/notify/detail&module=report'); ?>"
                                        class="anchor">查看详情</a></li>
                                <li rel="calendar"><span></span>，<a
                                        href="<?php echo Ibos::app()->urlManager->createUrl('message/notify/detail&module=calendar'); ?>"
                                        class="anchor">查看详情</a></li>
                                <li rel="workflow"><span></span>，<a
                                        href="<?php echo Ibos::app()->urlManager->createUrl('message/notify/detail&module=workflow'); ?>"
                                        class="anchor">查看详情</a></li>
                                <li rel="article"><span></span>，<a
                                        href="<?php echo Ibos::app()->urlManager->createUrl('message/notify/detail&module=article'); ?>"
                                        class="anchor">查看详情</a></li>
                                <li rel="officialdoc"><span></span>，<a
                                        href="<?php echo Ibos::app()->urlManager->createUrl('message/notify/detail&module=officialdoc'); ?>"
                                        class="anchor">查看详情</a></li>
                                <li rel="email"><span></span>，<a
                                        href="<?php echo Ibos::app()->urlManager->createUrl('message/notify/detail&module=email'); ?>"
                                        class="anchor">查看详情</a></li>
                                <li rel="assignment"><span></span>，<a
                                        href="<?php echo Ibos::app()->urlManager->createUrl('message/notify/detail&module=assignment'); ?>"
                                        class="anchor">查看详情</a></li>
                                <li rel="message"><span></span>，<a
                                        href="<?php echo Ibos::app()->urlManager->createUrl('message/notify/detail&module=message'); ?>"
                                        class="anchor">查看详情</a></li>
                                ...
                                <li rel="meeting"><span></span>，<a
                                        href="<?php echo Ibos::app()->urlManager->createUrl('message/notify/detail&module=meeting'); ?>"
                                        class="anchor">查看消息</a></li>
                                <li rel="car"><span></span>，<a
                                        href="<?php echo Ibos::app()->urlManager->createUrl('message/notify/detail&module=car'); ?>"
                                        class="anchor">查看消息</a></li>
                                <li rel="assets"><span></span>，<a
                                        href="<?php echo Ibos::app()->urlManager->createUrl('message/notify/detail&module=assets'); ?>"
                                        class="anchor">查看消息</a></li>
                            </ul>
                        </div>
                    </div>
    ...
    ':'); ?></p>
                    ...
                    <div class="uil-card-body">
                        ...
                        <div class="progress" title="Progress-bar">
                            <div
                                class="progress-bar <?php if (Ibos::app()->user->upgrade_percent
    > 90): ?>progress-bar-danger<?php else: ?>progress-bar-success<?php endif; ?>"
...
<?php if (Ibos::app()->user->isadministrator): ?><a class="btn" target="_blank"
                                   href="<?php echo Ibos::app()->urlManager->createUrl('dashboard/'); ?>" >
                                    <i class="om-key"></i><?php echo Ibos::lang('Control',
        'default'); ?></a><?php endif; ?>
                            <a href="<?php echo Ibos::app()->urlManager->createUrl('user/default/logout',
    array('formhash' => FORMHASH)); ?>"
                               class="btn">
                                <i class="om-shutdown"></i><?php echo Ibos::lang('Quit',
    'default'); ?>
                            </a>
                        </div>
                    </div>
...
<?php foreach ($breadCrumbs as $key => $value): ?>
                ...
                <div class="copyright">
                    <div class="quick-link">
                        <a target="_blank" href="http://doc.ibos.com.cn/"><?php echo Ibos::lang('Ibos help',
                               'default'); ?></a>
                        <span class="ilsep">|</span>
                        <a target="_blank"
                           href="http://kf.ibos.com.cn"><?php echo Ibos::lang('Ibos feedback',
                            'default'); ?></a>

                        <span class="ilsep">|</span>
                        <a target="_blank"
                           href="http://doc.ibos.com.cn/article/detail/id/256"><?php echo Ibos::lang('Chrome frame',
                        'default'); ?></a>
<?php if ($notSaas): ?>
                            <span class="ilsep">|</span>
