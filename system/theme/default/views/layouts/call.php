				...
				<form action="#" method="post" id="call_content_form">
					<div class="fun-box-body" id="fun_box_body">
						<div data-type="unidirec" class="call-content-wrap call-type-unidirec">
							...
							<div class="number-input-block mb">
								...
								<div class="clearfix">
									<div class="pull-left other-select-block">
										<input type="text" data-init="select"  id="other_phone_select" placeholder="您可以输入号码或者选人" />
									</div>
									<div class="pull-right">
							...
							<div>
								<a href="javascript:;" data-type="unidirec" class="btn btn-success phone-call-btn" data-action="call">呼叫</a>
							</div>
						</div>
						<div data-type="bidirec" class="call-content-wrap call-type-bidirec" style="display:none;">
							...
							<div>
								<a href="javascript:;" data-action="call" data-type="bidirec" class="btn btn-success phone-call-btn">呼叫</a>
							</div>
						</div>
						<div data-type="meeting" class="call-content-wrap call-type-meeting" style="display:none;">
							...
							<div>
								<a href="javascript:;" data-action="call" data-type="meeting" class="btn btn-success phone-call-btn">呼叫</a>
							</div>
						</div>
					</div>
				</form>
